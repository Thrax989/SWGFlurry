/*
 *	autogen/server/zone/objects/player/sessions/survey/SurveySession.h generated by engine3 IDL compiler 0.70
 */
...
public:
	...
	void rescheduleSampleResults(const ResourceSpawner* resourceSpawner, float density, const String& resname);
...
class SurveySessionPOD : public FacadePOD {
public:
	String _className;
	SurveySessionPOD();
	virtual void readObject(ObjectInputStream* stream);
