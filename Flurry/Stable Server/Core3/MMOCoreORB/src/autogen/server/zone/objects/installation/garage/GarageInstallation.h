/*
 *	autogen/server/zone/objects/installation/garage/GarageInstallation.h generated by engine3 IDL compiler 0.70
 */
...
class GarageInstallationPOD : public InstallationObjectPOD {
public:
...
#endif /*GARAGEINSTALLATIONPOD_H_*/
