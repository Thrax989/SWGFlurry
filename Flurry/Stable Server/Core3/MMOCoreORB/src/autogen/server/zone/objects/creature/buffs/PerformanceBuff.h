/*
 *	autogen/server/zone/objects/creature/buffs/PerformanceBuff.h generated by engine3 IDL compiler 0.70
 */
...
class PerformanceBuffPOD : public BuffPOD {
public:
