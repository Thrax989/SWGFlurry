/*
 *	autogen/server/zone/objects/area/CampSiteObserver.h generated by engine3 IDL compiler 0.70
 */
...
class CampSiteObserverPOD : public ObserverPOD {
public:
	Optional<ManagedWeakReference<CampSiteActiveAreaPOD* >> campArea;
