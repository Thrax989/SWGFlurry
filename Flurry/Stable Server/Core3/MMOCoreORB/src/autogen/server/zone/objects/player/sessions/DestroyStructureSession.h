/*
 *	autogen/server/zone/objects/player/sessions/DestroyStructureSession.h generated by engine3 IDL compiler 0.70
 */
...
public:
	...
	virtual ~DestroyStructureSessionPOD();
...
#endif /*DESTROYSTRUCTURESESSIONPOD_H_*/
