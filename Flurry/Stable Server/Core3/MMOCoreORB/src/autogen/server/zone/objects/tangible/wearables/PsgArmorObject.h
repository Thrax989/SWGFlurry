/*
 *	autogen/server/zone/objects/tangible/wearables/PsgArmorObject.h generated by engine3 IDL compiler 0.70
 */
...
class PsgArmorObjectPOD : public ArmorObjectPOD {
public:
