/*
 *	autogen/server/zone/managers/weather/WeatherManager.h generated by engine3 IDL compiler 0.70
 */
...
class WeatherManagerPOD : public ManagedServicePOD {
public:
	String _className;
	WeatherManagerPOD();
	virtual void readObject(ObjectInputStream* stream);
