/*
 *	autogen/server/zone/objects/player/sui/listbox/SuiListBox.h generated by engine3 IDL compiler 0.70
 */
...
class SuiListBoxPOD : public SuiBoxPOD {
public:
	Optional<Vector<ManagedReference<SuiListBoxMenuItemPOD* > >> menuItems;

	Optional<int> type;

	Optional<unsigned long long> next;

	Optional<unsigned long long> previous;
