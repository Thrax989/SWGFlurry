/*
 *	autogen/server/zone/objects/tangible/InstrumentObserver.h generated by engine3 IDL compiler 0.70
 */
...
public:
	...
	ManagedWeakReference<Instrument* > getInstrument() const;
...
class InstrumentObserverPOD : public ObserverPOD {
public:
	Optional<ManagedWeakReference<InstrumentPOD* >> instrument;
...
#endif /*INSTRUMENTOBSERVERPOD_H_*/
