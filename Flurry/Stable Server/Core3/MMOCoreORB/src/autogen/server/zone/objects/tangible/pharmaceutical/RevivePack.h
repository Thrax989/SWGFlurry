/*
 *	autogen/server/zone/objects/tangible/pharmaceutical/RevivePack.h generated by engine3 IDL compiler 0.70
 */
...
class RevivePackPOD : public PharmaceuticalObjectPOD {
public:
	Optional<float> healthWoundHealed;

	Optional<float> healthHealed;

	Optional<float> actionWoundHealed;

	Optional<float> actionHealed;

	Optional<float> mindWoundHealed;

	Optional<float> mindHealed;
