/*
 *	autogen/server/zone/objects/tangible/terminal/mission/MissionTerminal.h generated by engine3 IDL compiler 0.70
 */
...
class MissionTerminalPOD : public TerminalPOD {
public:
	Optional<String> terminalType;
