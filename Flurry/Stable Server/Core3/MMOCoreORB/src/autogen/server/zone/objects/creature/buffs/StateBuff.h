/*
 *	autogen/server/zone/objects/creature/buffs/StateBuff.h generated by engine3 IDL compiler 0.70
 */
...
public:
	StateBuff(CreatureObject* creo, unsigned long long buffState, int duration, unsigned long long secondaryCRC = 0);
...
public:
	StateBuffImplementation(CreatureObject* creo, unsigned long long buffState, int duration, unsigned long long secondaryCRC = 0);
...
class StateBuffPOD : public BuffPOD {
public:
	Optional<unsigned long long> stateApplied;
