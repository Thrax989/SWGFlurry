/*
 *	autogen/server/zone/objects/tangible/terminal/spaceship/SpaceshipTerminal.h generated by engine3 IDL compiler 0.70
 */
...
class SpaceshipTerminalPOD : public TerminalPOD {
public:
