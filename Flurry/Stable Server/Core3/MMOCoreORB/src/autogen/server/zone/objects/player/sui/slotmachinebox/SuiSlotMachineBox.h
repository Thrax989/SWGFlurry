/*
 *	autogen/server/zone/objects/player/sui/slotmachinebox/SuiSlotMachineBox.h generated by engine3 IDL compiler 0.70
 */
...
class SuiSlotMachineBoxPOD : public SuiListBoxPOD {
public:
	Optional<unsigned int> payoutBoxID;
