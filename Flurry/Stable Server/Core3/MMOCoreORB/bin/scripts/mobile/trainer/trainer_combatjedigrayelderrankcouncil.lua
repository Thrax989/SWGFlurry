trainer_combatjedigrayelderrankcouncil = Creature:new {
	objectName = "@mob/creature_names:trainer_combatjedigrayelderrankcouncil",
	planetMapCategory = "trainer_combatjedigrayelderrankcouncil",
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
