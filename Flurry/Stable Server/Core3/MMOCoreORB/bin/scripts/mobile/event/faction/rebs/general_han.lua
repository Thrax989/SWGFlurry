general_han = Creature:new {
	customName = "General Han Solo",
	socialGroup = "rebel",
	pvpFaction = "rebel",
	faction = "rebel",
	level = 300,
  ...
  lootGroups = {
	...
	attacks = merge(forcepowermaster,bountyhuntermaster,marksmanmaster,brawlermaster,pikemanmaster,fencermaster,swordsmanmaster,tkamaster,pistoleermaster,commandomaster)
}

CreatureTemplates:addCreatureTemplate(general_han, "general_han")