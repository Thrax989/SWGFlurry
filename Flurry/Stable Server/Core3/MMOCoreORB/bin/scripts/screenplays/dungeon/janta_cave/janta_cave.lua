...
function janta_cave:BroadcastRespawn(pPlayer)
		local player = LuaCreatureObject(pPlayer)
		player:broadcastToServer("\\#63C8F9 Janta Boss Has Died!")
		player:broadcastToDiscord("Janta Boss Has Died!")
		player:broadcastToServer("\\#63C8F9 Janta Boss Respawning In 3 Hours")
		player:broadcastToDiscord("Janta Boss Respawning In 3 Hours")
