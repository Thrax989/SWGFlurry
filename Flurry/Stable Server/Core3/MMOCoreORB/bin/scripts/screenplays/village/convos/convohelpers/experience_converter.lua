...
ExperienceConverter = ScreenPlay:new {
	xpConversion = {
		...
		crafting = {
			...
			{ "jedi_general", 3 },
			{ "crafting_clothing_armor", 3 },
			{ "crafting_clothing_general", 3 },
			{ "crafting_droid_general", 3 },
			{ "crafting_food_general", 3 },
			{ "crafting_general", 4 },
			{ "crafting_medicine_general", 3 },
			{ "crafting_spice", 3 },
			{ "crafting_structure_general", 5 },
			{ "crafting_weapons_general", 3 }
		}
	}
}
