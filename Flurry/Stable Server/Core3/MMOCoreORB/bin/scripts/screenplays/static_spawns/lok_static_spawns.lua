...
function LokStaticSpawnsScreenPlay:spawnMobiles()
	...
	spawnMobile("lok", "dune_kimogila",450,5,-52,-181,0,0)
	spawnMobile("lok", "kimogila",450,112,-91,-332,0,0)
	spawnMobile("lok", "kimogila",450,25,-119,-378,0,0)
	spawnMobile("lok", "dune_kimogila",450,-11,-12,-367,0,0)
	spawnMobile("lok", "aged_kimogila",450,-9,-78,-360,0,0)
	spawnMobile("lok", "enraged_dune_kimogila",450,-113,-84,-329,0,0)
