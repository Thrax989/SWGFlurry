...
if (((bossHealth <= (bossMaxHealth * 0.7)) or (bossAction <= (bossMaxAction * 0.7)) or (bossMind <= (bossMaxMind * 0.7))) and readData("baxter_stockman:spawnState") == 3) then
      ...
      local threespawn = spawnMobile("lok", "mutated_varasquactyl", 0, 2940.46, 290, -4688.26, 132, 0)
      local threespawn = spawnMobile("lok", "mutated_varasquactyl", 0, 2944.45, 290, -4683.93, 110, 0)
      local threespawn = spawnMobile("lok", "mutated_varasquactyl", 0, 2948.69, 290, -4687.48, 106, 0)
      local threespawn = spawnMobile("lok", "mutated_varasquactyl", 0, 2944.06, 290, -4692.23, 78, 0)
...
if (((bossHealth <= (bossMaxHealth * 0.6)) or (bossAction <= (bossMaxAction * 0.6)) or (bossMind <= (bossMaxMind * 0.6))) and readData("baxter_stockman:spawnState") == 4) then
      ...
      local fourspawn = spawnMobile("lok", "mutated_chuba_fly", 0, 2940.46, 290, -4688.26, 132, 0)
      local fourspawn = spawnMobile("lok", "mutated_chuba_fly", 0, 2944.45, 290, -4683.93, 110, 0)
      local fourspawn = spawnMobile("lok", "mutated_chuba_fly", 0, 2948.69, 290, -4687.48, 106, 0)
      local fourspawn = spawnMobile("lok", "mutated_chuba_fly", 0, 2944.06, 290, -4692.23, 78, 0)
...
if (((bossHealth <= (bossMaxHealth * 0.2)) or (bossAction <= (bossMaxAction * 0.2)) or (bossMind <= (bossMaxMind * 0.2))) and readData("baxter_stockman:spawnState") == 8) then
      ...
      local eightspawn = spawnMobile("lok", "mutated_rancor", 0, 2940.46, 290, -4688.26, 132, 0)
      local eightspawn = spawnMobile("lok", "mutated_blackwing_rancor", 0, 2944.45, 290, -4683.93, 110, 0)
      local eightspawn = spawnMobile("lok", "mutated_rancor", 0, 2948.69, 290, -4687.48, 106, 0)
...
if (((bossHealth <= (bossMaxHealth * 0.1)) or (bossAction <= (bossMaxAction * 0.1)) or (bossMind <= (bossMaxMind * 0.1))) and readData("baxter_stockman:spawnState") == 9) then
      ...
      local ninespawn = spawnMobile("lok", "mutated_kimogila", 0, 2940.46, 290, -4688.26, 132, 0)
      local ninespawn = spawnMobile("lok", "mutated_kimogila", 0, 2944.45, 290, -4683.93, 110, 0)
      local ninespawn = spawnMobile("lok", "mutated_kimogila", 0, 2948.69, 290, -4687.48, 106, 0)
      local ninespawn = spawnMobile("lok", "mutated_kimogila", 0, 2944.06, 290, -4692.23, 78, 0)
