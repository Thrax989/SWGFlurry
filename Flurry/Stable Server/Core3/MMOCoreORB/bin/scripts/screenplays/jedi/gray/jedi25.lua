...
registerScreenPlay("jedi25", true)
  
function jedi25:start()
    	self:spawnActiveAreas()
end
  
function jedi25:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi25", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi25", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi25:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi25:notifySpawnAreaLeave(pActiveArea, pMovingObject)
