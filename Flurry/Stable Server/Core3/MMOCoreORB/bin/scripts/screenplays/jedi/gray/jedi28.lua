...
registerScreenPlay("jedi28", true)
  
function jedi28:start()
    	self:spawnActiveAreas()
end
  
function jedi28:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi28", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi28", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi28:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi28:notifySpawnAreaLeave(pActiveArea, pMovingObject)
