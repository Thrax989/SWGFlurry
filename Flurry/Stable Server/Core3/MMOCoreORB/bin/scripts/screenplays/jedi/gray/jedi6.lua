...
registerScreenPlay("jedi6", true)
  
function jedi6:start()
    	self:spawnActiveAreas()
end
  
function jedi6:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi6", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi6", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi6:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi6:notifySpawnAreaLeave(pActiveArea, pMovingObject)
