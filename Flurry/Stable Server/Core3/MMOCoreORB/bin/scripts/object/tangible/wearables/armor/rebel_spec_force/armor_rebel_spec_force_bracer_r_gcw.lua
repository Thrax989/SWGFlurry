...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_spec_force_armor_rebel_spec_force_bracer_r_gcw, "object/tangible/wearables/armor/rebel/spec/force/armor_rebel_spec_force_bracer_r_gcw.iff")
