...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_battle_armor_rebel_battle_gloves, "object/tangible/wearables/armor/rebel/battle/armor_rebel_battle_gloves.iff")
