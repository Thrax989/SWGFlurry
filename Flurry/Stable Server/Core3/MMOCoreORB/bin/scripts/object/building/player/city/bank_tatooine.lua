...
allowedZones = {"corellia", "dantooine", "lok", "naboo", "rori", "talus", "tatooine", "yavin4", "dathomir", "endor", "kashyyyk", "hoth", "mandalore", "taanab", "kaas", "moraban", "coruscant", "hutta", "chandrila", "jakku"},	length = 4,
	width = 4,
	cityRankRequired = 2,
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_bazaar.iff", x = -1, z = 0, y = 0, ox = 0, oy = -0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_mission.iff", x = 0, z = 0, y = 1, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
