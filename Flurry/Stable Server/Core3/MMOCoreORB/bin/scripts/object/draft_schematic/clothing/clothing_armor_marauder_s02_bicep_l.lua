object_draft_schematic_clothing_clothing_armor_marauder_s02_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_marauder_s02_bicep_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Armor Left Bicep",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s02_bicep_l, "object/draft_schematic/clothing/clothing_armor_marauder_s02_bicep_l.iff")
