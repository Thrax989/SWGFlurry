...
object_draft_schematic_vehicle_civilian_rebel_barc_speeder = object_draft_schematic_vehicle_civilian_shared_rebel_barc_speeder:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Rebel Command BARC Speeder",
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_rebel_barc_speeder, "object/draft_schematic/vehicle/civilian/rebel_barc_speeder.iff")
