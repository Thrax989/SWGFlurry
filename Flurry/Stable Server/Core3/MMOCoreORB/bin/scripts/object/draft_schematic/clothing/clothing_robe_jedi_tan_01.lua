...
object_draft_schematic_clothing_clothing_robe_jedi_tan_01 = object_draft_schematic_clothing_shared_clothing_robe_jedi_tan_01:new {

   	templateType = DRAFTSCHEMATIC,

   	customObjectName = "Robes of Galen Marek",
	...
	disableFactoryRun = true,
   	...
   	targetTemplate = "object/tangible/wearables/robe/robe_jedi_tan_01.iff",

   	additionalTemplates = {
             },

}
ObjectTemplates: addTemplate(object_draft_schematic_clothing_clothing_robe_jedi_tan_01, "object/draft_schematic/clothing/clothing_robe_jedi_tan_01.iff")