...
object_draft_schematic_scout_item_camp_luxury = object_draft_schematic_scout_shared_item_camp_luxury:new {
   ...
   ingredientTitleNames = {"shelter_canvas", "shelter_structure", "shelter_reinforcement", "strap_pad"},
   ingredientSlotType = {0, 0, 0, 0},
   resourceTypes = {"hide", "bone", "metal", "object/tangible/component/clothing/shared_leather_heavy_duty.iff"},
