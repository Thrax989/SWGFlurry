object_draft_schematic_weapon_appearance_weapon_appearance_carbine_blaster_cdef_corsec = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_blaster_cdef_corsec:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Cdef Corsec Blaster Carbine",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_blaster_cdef_corsec, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_blaster_cdef_corsec.iff")
