object_draft_schematic_weapon_lightsaber_polearm_pvp_bf_gen5 = object_draft_schematic_weapon_shared_lightsaber_polearm_pvp_bf_gen5:new {
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_pvp_bf_gen5.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_polearm_pvp_bf_gen5, "object/draft_schematic/weapon/lightsaber_polearm_pvp_bf_gen5.iff")
