...
object_tangible_wearables_cybernetic_shared_cyborg_crafting_headband_s01 = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/cybernetic/shared_cyborg_crafting_headband_s01.iff"
	
}

ObjectTemplates:addClientTemplate(object_tangible_wearables_cybernetic_shared_cyborg_crafting_headband_s01, "object/tangible/wearables/cybernetic/shared_cyborg_crafting_headband_s01.iff")
