object_draft_schematic_vehicle_civilian_pod_racer_one = object_draft_schematic_vehicle_civilian_shared_pod_racer_one:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Pod Racer One",
...
--********************************************************************************
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/pod_racer_one_deed.iff",

	additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_pod_racer_one, "object/draft_schematic/vehicle/civilian/pod_racer_one.iff")
