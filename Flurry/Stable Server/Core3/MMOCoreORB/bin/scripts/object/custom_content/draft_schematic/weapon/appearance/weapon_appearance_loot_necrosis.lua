object_draft_schematic_weapon_appearance_weapon_appearance_loot_necrosis = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_necrosis:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_necrosis, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_necrosis.iff")
