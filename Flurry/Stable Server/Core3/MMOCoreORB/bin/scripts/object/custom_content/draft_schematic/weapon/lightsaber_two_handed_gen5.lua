object_draft_schematic_weapon_lightsaber_two_handed_gen5 = object_draft_schematic_weapon_shared_lightsaber_two_handed_gen5:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_two_handed_gen5, "object/draft_schematic/weapon/lightsaber_two_handed_gen5.iff")
