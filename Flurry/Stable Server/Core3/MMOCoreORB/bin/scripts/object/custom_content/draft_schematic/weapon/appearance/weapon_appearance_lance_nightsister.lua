object_draft_schematic_weapon_appearance_weapon_appearance_lance_nightsister = object_draft_schematic_weapon_appearance_shared_weapon_appearance_lance_nightsister:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_lance_nightsister, "object/draft_schematic/weapon/appearance/weapon_appearance_lance_nightsister.iff")
