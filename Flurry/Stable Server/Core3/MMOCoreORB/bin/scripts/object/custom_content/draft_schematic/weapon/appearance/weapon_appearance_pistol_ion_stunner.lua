object_draft_schematic_weapon_appearance_weapon_appearance_pistol_ion_stunner = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_ion_stunner:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_ion_stunner, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_ion_stunner.iff")
