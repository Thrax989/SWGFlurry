object_draft_schematic_weapon_appearance_weapon_appearance_carbine_slug = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_slug:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Slug Carbine",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_slug, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_slug.iff")
