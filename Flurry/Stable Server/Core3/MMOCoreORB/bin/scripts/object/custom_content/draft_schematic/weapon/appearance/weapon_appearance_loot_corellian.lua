object_draft_schematic_weapon_appearance_weapon_appearance_loot_corellian = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_corellian:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_corellian, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_corellian.iff")
