object_draft_schematic_weapon_appearance_weapon_appearance_loot_nullifier = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_nullifier:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_nullifier, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_nullifier.iff")
