object_draft_schematic_weapon_appearance_weapon_appearance_rifle_westar_pvp = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_westar_pvp:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Pvp Westar Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_westar_pvp, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_westar_pvp.iff")
