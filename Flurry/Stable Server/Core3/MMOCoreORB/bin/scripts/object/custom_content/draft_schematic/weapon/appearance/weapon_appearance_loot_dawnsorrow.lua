object_draft_schematic_weapon_appearance_weapon_appearance_loot_dawnsorrow = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_dawnsorrow:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_dawnsorrow, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_dawnsorrow.iff")
