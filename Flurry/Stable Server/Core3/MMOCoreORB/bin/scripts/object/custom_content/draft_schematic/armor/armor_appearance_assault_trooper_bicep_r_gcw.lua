object_draft_schematic_armor_armor_appearance_assault_trooper_bicep_r_gcw = object_draft_schematic_armor_shared_armor_appearance_assault_trooper_bicep_r_gcw:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_assault_trooper_bicep_r_gcw, "object/draft_schematic/armor/armor_appearance_assault_trooper_bicep_r_gcw.iff")
