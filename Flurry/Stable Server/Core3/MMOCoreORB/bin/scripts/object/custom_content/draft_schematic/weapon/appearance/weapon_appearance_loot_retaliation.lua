object_draft_schematic_weapon_appearance_weapon_appearance_loot_retaliation = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_retaliation:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_retaliation, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_retaliation.iff")
