object_draft_schematic_weapon_appearance_weapon_appearance_carbine_specops_bothan_carbine = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_specops_bothan_carbine:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_specops_bothan_carbine, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_specops_bothan_carbine.iff")
