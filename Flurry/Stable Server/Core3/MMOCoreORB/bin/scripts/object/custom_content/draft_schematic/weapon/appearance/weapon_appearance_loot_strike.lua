object_draft_schematic_weapon_appearance_weapon_appearance_loot_strike = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_strike:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_strike, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_strike.iff")
