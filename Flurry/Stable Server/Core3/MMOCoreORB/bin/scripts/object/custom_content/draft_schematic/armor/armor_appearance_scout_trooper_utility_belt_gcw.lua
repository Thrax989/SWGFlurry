...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_scout_trooper_utility_belt_gcw, "object/draft_schematic/armor/armor_appearance_scout_trooper_utility_belt_gcw.iff")
