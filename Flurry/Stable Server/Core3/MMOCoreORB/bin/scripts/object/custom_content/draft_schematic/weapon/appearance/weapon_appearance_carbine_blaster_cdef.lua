object_draft_schematic_weapon_appearance_weapon_appearance_carbine_blaster_cdef = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_blaster_cdef:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Cdef Blaster Carbine",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_blaster_cdef, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_blaster_cdef.iff")
