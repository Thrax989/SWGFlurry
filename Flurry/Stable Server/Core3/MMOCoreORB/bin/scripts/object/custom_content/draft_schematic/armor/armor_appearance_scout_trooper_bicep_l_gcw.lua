object_draft_schematic_armor_armor_appearance_scout_trooper_bicep_l_gcw = object_draft_schematic_armor_shared_armor_appearance_scout_trooper_bicep_l_gcw:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_scout_trooper_bicep_l_gcw, "object/draft_schematic/armor/armor_appearance_scout_trooper_bicep_l_gcw.iff")
