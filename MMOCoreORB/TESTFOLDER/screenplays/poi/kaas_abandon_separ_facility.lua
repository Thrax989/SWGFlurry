...
-- Entrance
	...
	spawnMobile("kaas", "dolac_dark_jedi_knight", 200, -20, -22.0, -114.2, 179, 35791518)
	...
	spawnMobile("kaas", "dolac_dark_jedi_knight", 200, -117.8, -34.0, -349.9, -90, 35791534)
	...
	spawnMobile("kaas", "krayt_dragon_ancient", 3900, 96.8, -34.2, -327.8, -90, 35791539)
