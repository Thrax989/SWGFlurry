...
function WeaponFacilityScreenPlay:spawnRebels(pBuilding)
	...
	if pBuilding ~= nil then
		...
		building:spawnChildSceneObject("object/tangible/furniture/decorative/bacta_tank.iff", 6.7, -12.0, 41.4, 6335643, 1, 0, 0, 0)
		building:spawnChildSceneObject("object/tangible/furniture/decorative/bacta_tank.iff", 0.2, -12.0, 41.4, 6335643, 1, 0, 0, 0)

    	--Cell [0]
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6496.0, 40.0, -3324.7, -133, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6515.3, 40.0, -3325.9, 131, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6516.8, 40.0, -3313.5, -101, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6494.9, -40.0, -3313.6, 98, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6482.7, 40.0, -3279.1, -61, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6483.2, -40.0, -3291.2, -128, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6489.1, 40.0, -3284.2, -4, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6500.1, 40.0, -3283.7, -91, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6493.1, 40.0, -3289.4, 156, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6511.9, 40.0, -3279.4, -87, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6511.8, 40.0, -3277.2, -95, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6494.0, 40.0, -3271.8, 49, 0)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -6502.8, 40.0, -3260.9, -20, 0)

    	--Cell [6335640]
        	building:spawnChildCreature("death_watch_battle_droid", 300, -4.1, 0.3, 0.7, 169, 6335640)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -2.0, 0.3, 2.5, 172, 6335640)
        	building:spawnChildCreature("death_watch_battle_droid", 300, -3.3, 0.3, -5.0, 0, 6335640)
...
--        	building:spawnChildCreature("specforce_marine", 300, 4.2, -12.0, 21.9, 82, 6335642)
    	...
    	--Cell [6335643]
        	building:spawnChildCreature("stormtrooper_pve", 300, 10.7, -12.0, 29.1, 0, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 4.5, -12.0, 30.7, -157, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -3.4, -12.0, 32.8, -164, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 3.1, -12.0, 40.1, -39, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 18.1, -12.0, 40.3, -109, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 19.5, -12.0, 49.4, 0, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 26.5, -12.0, 43.2, -38, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 11.5, -12.0, 49.1, -30, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 26.6, -12.0, 49.5, 89, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -2.6, -12.0, 62.2, -83, 6335643)
        	building:spawnChildCreature("thrawn_pve", 1800, 5.1, -12.0, 64.6, -145, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 1.4, -12.0, 63.0, 85, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 5.3, -12.0, 61.4, -49, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 9.6, -12.0, 63.8, 103, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 6.1, -12.0, 67.3, 3, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -1.7, -12.0, 68.8, -35, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, 0.2, -12.0, 53.3, -179, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -10.9, -12.0, 50.2, -52, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -19.2, -12.0, 43.7, 6, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -19.4, -12.0, 49.6, -98, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -13.1, -12.0, 40.9, 159, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -1.3, -12.0, 48.2, 170, 6335643)
        	building:spawnChildCreature("stormtrooper_pve", 300, -9.8, -12.0, 47.0, -97, 6335643)
...
--        	building:spawnChildCreature("senior_specforce_infiltrator", 300, -73.0, -20.0, 36.9, -41, 6335645)
    	...
    	--Cell [6335646]
        	building:spawnChildCreature("palpatine_pve", 1800, -48.7, -20.0, 14.5, -68, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -70.0, -20.0, 16.4, 93, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -70.0, -20.0, 9.8, 86, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -76.2, -20.0, 8.8, -119, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -74.7, -20.0, 13.0, 88, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -61.1, -20.0, 13.0, -90, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -62.9, -20.0, 19.1, 1, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -59.1, -20.0, 6.9, 172, 6335646)
        	building:spawnChildCreature("stormtrooper_pve", 300, -56.3, -20.0, 11.8, 165, 6335646)
        	building:spawnChildCreature("darth_vader_pve", 300, -49.3, -20.0, 18.2, 44, 6335646)
...
--        	building:spawnChildCreature("specforce_marine", 300, -55.7, -20.0, 86.4, -148, 6335647)
    	...
    	--Cell [6335652]
        	building:spawnChildCreature("slave_pve", 300, 40.3, -12.0, 9.4, -176, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 22.2, -12.0, 24.9, 13, 6335652)
        	building:spawnChildCreature("salacious_crumb_pve", 1800, 26.2, -12.0, 3.5, -4, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 23.3, -12.0, 11.8, 43, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 28.2, -12.0, 2.6, 64, 6335652)
        	building:spawnChildCreature("jabba_the_hutt_pve", 1800, 20.0, -12.0, 3.1, 25, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 58.6, -12.0, 2.4, -14, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 54.0, -12.0, -0.9, 174, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 44.1, -12.0, -0.9, 170, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 37.9, -12.0, 4.3, -14, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 61.8, -12.0, 12.5, 10, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 48.3, -12.0, 12.4, -8, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 42.2, -12.0, 20.0, -169, 6335652)
        	building:spawnChildCreature("slave_pve", 300, 52.1, -12.0, 22.8, 4, 6335652)

    	--Cell [6335654]
        	building:spawnChildCreature("vette_battle_droid", 300, -22.7, -20.0, -3.0, 169, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -21.3, -20.0, -1.7, -2, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -13.0, -20.0, -2.9, 172, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -10.0, -20.0, -2.7, 89, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -9.9, -20.0, 8.5, -110, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -13.9, -20.0, 7.8, 171, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -19.7, -20.0, 9.1, 2, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -23.2, -20.0, 8.9, -98, 6335654)
        	building:spawnChildCreature("vette_battle_droid", 300, -19.6, -20.0, -3.3, 176, 6335654)
        	building:spawnChildCreature("boba_fett_pve", 300, -15.7, -20.0, 2.6, -79, 6335654)
...
--        	building:spawnChildCreature("senior_specforce_infiltrator", 300, 3.4, -20.0, 64.8, 166, 6335659)
    	...
    	--Cell [6335650]
        	building:spawnChildCreature("luke_skywalker_pve", 300, 69.4, -12.0, 59.7, -15, 6335650)
        	building:spawnChildCreature("leia_organa_pve", 300, 69.0, -12.0, 57.9, 174, 6335650)
        	building:spawnChildCreature("rebel_pve", 300, 60.7, -12.0, 59.6, 32, 6335650)
        	building:spawnChildCreature("rebel_pve", 300, 53.1, -12.0, 57.7, -170, 6335650)
        	building:spawnChildCreature("rebel_pve", 300, 46.8, -12.0, 59.7, -5, 6335650)
        	building:spawnChildCreature("rebel_pve", 300, 44.6, -12.0, 53.1, 1, 6335650)

    	--Cell [6335649]
        	building:spawnChildCreature("rebel_pve", 300, 50.1, -12.0, 84.7, -9, 6335649)
        	building:spawnChildCreature("rebel_pve", 300, 50.9, -12.0, 81.2, 178, 6335649)
        	building:spawnChildCreature("rebel_pve", 300, 57.7, -12.0, 81.2, 175, 6335649)
        	building:spawnChildCreature("rebel_pve", 300, 67.3, -12.0, 84.7, -17, 6335649)
        	building:spawnChildCreature("han_solo_pve", 1800, 73.7, -12.0, 81.2, -176, 6335649)
        	building:spawnChildCreature("chewbacca_pve", 1800, 71.6, -12.0, 84.7, 8, 6335649)

    	--Cell [6335651]
        	building:spawnChildCreature("rebel_pve", 300, 21.9, -20.0, 120.0, -30, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 13.5, -20.0, 127.3, 56, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 18.3, -20.0, 145.9, 42, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 38.7, -20.0, 121.8, 92, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 38.2, -20.0, 127.6, 122, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 41.7, -20.0, 133.4, 73, 6335651)
        	building:spawnChildCreature("ackbar_pve", 300, 36.4, -20.0, 145.9, -10, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 32.8, -20.0, 125.4, 38, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 26.7, -20.0, 131.9, -40, 6335651)
        	building:spawnChildCreature("rebel_pve", 300, 19.6, -20.0, 136.9, 156, 6335651)
	end
end

function WeaponFacilityScreenPlay:spawnStructures()
--no build zone
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6510.0, 40.0, -3301.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6460.0, 40.0, -3115.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6552.0, 40.0, -3485.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6694.0, 40.0, -3259.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6325.0, 40.0, -3251.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6321.0, 40.0, -3272.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6688.0, 40.0, -3359.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6547.0, 40.0, -3115.0, 0, 0, 0, 0, 0)
	spawnSceneObject("naboo", "object/static/structure/general/fs_village_nobuild_768m.iff", -6361.0, 40.0, -3419.0, 0, 0, 0, 0, 0)
end
