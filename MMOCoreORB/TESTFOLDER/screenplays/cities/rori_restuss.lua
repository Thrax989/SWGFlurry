...
function RoriRestussScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "first_brigade_marine", 300, 5409, 80.2, 5906, -10, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5406, 80.2, 5908.3, -15, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5406, 80.0, 5913, -1, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5415, 80.2, 5910, -45, 0)
	spawnMobile("rori", "first_brigade_officer", 300, 5412, 80.2, 5917, 5, 0)

	spawnMobile("rori", "first_brigade_marine", 300, 5173, 79, 5873, -90, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5171, 79, 5868, -80, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5162, 79.0, 5867, -10, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5158, 79.2, 5868, 80, 0)
	spawnMobile("rori", "first_brigade_officer", 300, 5158, 79.2, 5876, 135, 0)

	spawnMobile("rori", "first_brigade_marine", 300, 5223, 80.2, 5542, -90, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5223, 80.2, 5537, -90, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5223, 80.0, 5530, -90, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5214, 80.2, 5532, -90, 0)
	spawnMobile("rori", "first_brigade_officer", 300, 5214, 80.2, 5541, 1, 0)

	spawnMobile("rori", "first_brigade_marine", 300, 5357, 80.2, 5557, -15, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5353, 80.0, 5555, -1, 0)
	spawnMobile("rori", "first_brigade_marine", 300, 5356, 80.2, 5555, -45, 0)
	spawnMobile("rori", "first_brigade_officer", 300, 5351, 80.2, 5548, 5, 0)
...
--	spawnMobile("rori", "imperial_recruiter", 1, 5349, 80, 5617.6, 0, 0)
	...
	--Emperors Hand
	spawnMobile("rori", "emperors_hand", 10800, 5273.1, 80.0, 5745.4, 4, 0)
end
