...
rebelRewardData = {
	...
	hirelingList = {
		...
		"specforce_procurement_specialist", "specforce_technician",	"specforce_wilderness_operative", "rebel_specforce_guerrilla", "altered_spider_droid"
	},
	...
	hirelings = {
		...
		altered_spider_droid = { type=factionRewardType.hireling, display="@mob/creature_names:warren_bomarr_loyalist", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="alliance_battle_droid", cost=79450},
	}
}
...
imperialRewardData = {
	...
	hirelings = {
		...
		at_st = { type=factionRewardType.hireling, display="@mob/creature_names:at_st", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="at_st", cost=79450},
	},
}
