...
npcMapJabba =
	{
		...
		{
			spawnData = { planetName = "tatooine", npcTemplate = "ephant_mon", x = -6, z = 5.85, y = 84, direction = 277.481, cellID = 1177469, position = PRONE },
		...
		{
			spawnData = { planetName = "tatooine", npcTemplate = "g_5po", x = -14.1, z = 2, y = 46.9, direction = 119.771, cellID = 1177487, position = STAND },
			worldPosition = { x = -5958.0, y = -6260.0 },
			npcNumber = 64,
