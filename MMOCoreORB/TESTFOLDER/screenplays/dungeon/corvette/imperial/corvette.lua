...
--------------------------------------------------------------
spawnMapImperial =  {
		{"rebel_ensign_corv", 0, -10, 0, -10.2, -10, 4336209},
		{"rebel_ensign_corv", 0, 4.9, 0, -30.9, -10, 4336213},
		{"rebel_ensign_corv", 0, 5, 0, -20.9, 170, 4336213},
		{"rebel_ensign_corv", 0, 26.2, 0, 0, -100, 4336207},
		{"rebel_ensign_corv", 0, 20, 0, 16, -10, 4336206},
		{"rebel_sailor_corv", 0, 4.7, 0, 50, -100, 4336203},
		{"rebel_commandant_corv", 0, 14.3, 0, 51.6, -100, 4336203},
		{"rebel_commandant_corv", 0, -2.6, 0, 60.5, 170, 4336203},
		{"rebel_ensign_corv", 0, 5.0, 0, 18.1, 80, 4336201},
		{"rebel_ensign_corv", 0, -0.1, 0, 9.4, -10, 4336199},
		{"rebel_ensign_corv", 0, 0, 0, 23.3, 170, 4336199},

		{"rebel_ensign_corv", 0, 10, 0, 17.6, 170, 4336208},

		{"rebel_commandant_corv", 0, -2.9, 12, -16.3, 170, 4336216},
		{"rebel_commandant_corv", 0, -2.9, 12, 14.9, 170, 4336216},
		{"rebel_admiral_corv", 0, 1, 12, -8.2, -10, 4336217},
		{"rebel_commandant_corv", 0, 3, 12, -0.7, 170, 4336217},

		{"rebel_admiral_corv", 0, 2.8, 12, 4.1, -10, 4336218},
		{"rebel_commandant_corv", 0, 4.9, 12, 15, 170, 4336218},
	
		{"rebel_engineer_corv", 0, 6.4, 15, 37, -10, 4336219},
		{"rebel_commandant_corv", 0, 3.6, 15, 37, -10, 4336219},
		{"rebel_sailor_corv", 0, 0.9, 15, 33.7, -135, 4336219},

		{"rebel_first_mate_corv", 0, 0, -12, 28.5, -10, 4336227},

		{"rebel_ensign_corv", 0, 26.2, -12, 27.9, -100, 4336230},

		{"rebel_commandant_corv", 0, 10.9, -12, 5.4, -10, 4336229},

		{"rebel_sailor_corv", 0, 2.8, 0, -40.2, -100, 4336220},
		{"rebel_sailor_corv", 0, -7.2, 0, -37.7, -100, 4336220},
		...
		{"rebel_engineer_corv", 0, -11.2, -12, 5.3, -10, 4336234},
		{"rebel_sailor_corv", 0, -7.4, -12, 11.2, 170, 4336234},
		{"rebel_commandant_corv", 0, -4.1, -12, 6.3, -100, 4336234},

		{"rebel_ensign_corv", 0, -25, -12, 28, 80, 4336235},

		{"rebel_commandant_corv", 0, -6.4, -6.7, -36, -100, 4336223},
		{"rebel_commandant_corv", 0, -6, -6.7, -39.9, -10, 4336223},

		{"rebel_first_mate_corv", 0, -7.6, -12, 40.8, -150, 4336238},

		{"rebel_commodore_corv", 0, 2.6, -12, 55, -150, 4336236},

		{"rebel_commodore_corv", 0, -2.7, -12, 71, 80, 4336243},
		{"rebel_commodore_corv", 0, 3.3, -12, 73.6, -10, 4336243},

		{"rebel_admiral_corv", 0, 24.5, -12, 62.8, -100, 4336241},
		{"rebel_commodore_corv", 0, 17.6, -12, 69.5, -10, 4336241},

		{"rebel_ensign_corv", 0, -22.6, -12, 51.8, 80, 4336244},

		{"rebel_commandant_corv", 0, -21.1, -12, 68.3, 170, 4336242},
		{"rebel_sailor_corv", 0, -24.6, -12, 64.1, 80, 4336242},
		{"rebel_sailor_corv", 0, -17.4, -12, 64.1, -100, 4336242},

		{"rebel_commandant_corv", 0, 0, -12, 100.7, 170, 4336248},

		{"rebel_commandant_corv", 0, -17, -12, 112.9, 130, 4336249},
		{"rebel_commandant_corv", 0, 17, -12, 112.9, -150, 4336249},

		{"rebel_commandant_corv", 0, 0, -12, 117.4, 170, 4336250},
		{"rebel_commandant_corv", 0, -5.8, -12, 127.5, 170, 4336250},

		{"rebel_commandant_corv", 0, -5.4, -12, 133.6, 170, 4336251},
		{"rebel_commandant_corv", 0, 5.6, -12, 132.7, -100, 4336251},

		{"rebel_commandant_corv", 0, 0, -24, 98.3, -10, 4336254},

		{"rebel_commodore_corv", 0, 3.3, -27, 75.6, 157, 4336256},
		{"rebel_commandant_corv", 0, 3.2, -27, 78.6, 45, 4336256},

		{"rebel_commandant_corv", 0, 0.7, 0, 111.5, -100, 4336257},
		{"rebel_admiral_corv", 0, -16.3, 0, 112, -50, 4336257},

		{"rebel_first_mate_corv", 0, 0, 0, 127.8, 170, 4336258},

	--"Rebel Commander", 0, -5.8, 0, 133.1, -10, 4336261},	
		{"rebel_commandant_corv", 0, -3.5, 0, 125.3, -10, 4336261},

		{"rebel_admiral_corv", 0, 3.8, 0, 124.9, -10, 4336260},
		{"rebel_commandant_corv", 0, 6.7, 0, 134.4, 170, 4336260},

		{"rebel_admiral_corv", 0, 0, 0, 150.3, -10, 4336262},
		{"rebel_commandant_corv", 0, -4.4, 0, 148.3, 130, 4336262},
		{"rebel_commandant_corv", 0, 4.5, 0, 148.3, -150, 4336262}
	},
...
spawnMapNeutral =  {
		...
		{"rebel_admiral_corv", 0, 24.5, -12, 62.8, -100, 4336241},
		{"rebel_commodore"_corv, 0, 17.6, -12, 69.5, -10, 4336241},
...
spawnMapRebel =  {
		...
		{"rebel_commandant_corv", 0, 14.3, 0, 51.6, -100, 4336203},
		{"rebel_commandant_corv", 0, -2.6, 0, 60.5, 170, 4336203},
		{"imperial_trooper_corv", 0, -10.9, 0, 18.1, 80, 4336201},
		{"rebel_ensign_corv", 0, -0.1, 0, 9.4, -10, 4336199},
		{"rebel_ensign_corv", 0, 0, 0, 23.3, 170, 4336199},
		...
		{"rebel_rear_admiral_corv", 0, 2.8, 12, 4.1, -10, 4336218},
		{"rebel_commandant_corv", 0, 4.9, 12, 15, 170, 4336218},
