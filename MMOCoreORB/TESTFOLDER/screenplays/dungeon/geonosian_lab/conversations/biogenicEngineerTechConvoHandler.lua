...
function BiogenicEngineerTechConvoHandler:runScreenHandlers(pConversationTemplate, pConversingPlayer, pConversingNPC, selectedOption, conversationScreen)
	...
	if screenID == "init_talk" then
		if (geonosian_labscreenplay:hasGeoItem(pConversingPlayer, "object/tangible/loot/dungeon/geonosian_mad_bunker/engineering_datapad.iff")) then
	...
	elseif (screenID == "yes_here_are_codes" or screenID == "oh_yes_codes") and geonosian_labscreenplay:hasGeoItem(pConversingPlayer, "object/tangible/loot/dungeon/geonosian_mad_bunker/engineering_datapad.iff") then
		geonosian_labscreenplay:removeGeoItem(pConversingPlayer, "object/tangible/loot/dungeon/geonosian_mad_bunker/engineering_datapad.iff")
		geonosian_labscreenplay:giveGeoItem(pConversingPlayer, "object/tangible/loot/dungeon/geonosian_mad_bunker/engineering_key.iff")
