...
--	self:barkShuttleLocation(pBarker)
	...
	local pBarker = spawnMobile("corellia", "royal_imperial_guard", 1, -146, 28, -4718, 140, 0)
	local barker = LuaCreatureObject(pBarker)
	barker:setOptionsBitmask(256)
	self:barkShuttleLocation(pBarker)
...
--	spawnSceneObject("yavin4", "object/tangible/terminal/terminal_character_builder.iff", -6479.1, 84.2, -435.3, 0, 0.4771588, 0, -0.8788171, 0)
	...
	createObserver(OBJECTRADIALUSED, "stresstest_20120128", "teleportCnet", pCollector5)
...
--	spawnSceneObject("corellia", "object/tangible/terminal/terminal_character_builder.iff", -475, 28, -4501, 0, 1, 0, 0, 0)
	...
	createObserver(OBJECTRADIALUSED, "stresstest_20120128", "teleportDWB", pCollector6)
end

function stresstest_20120128:barkShuttleLocation(pBarker)
	if (pBarker ~= nil) then
		spatialChat(pBarker, "\\#881100Attention Citizens!\n\nThe Empire needs your help! The Tusken King has taken over Mos Espa on Tatooine! The Emperor demands he be dispatched at once. He is carrying riches on his person that you may keep as payment for your service to the Empire, now go!")
		createEvent(99000, "stresstest_20120128", "barkShuttleLocation", pBarker)
	end
end
