...
void PlayerObjectImplementation::notifyOnline() {
	...
	box->setPromptTitle("SWG Flurry");
  	...
  	promptText << "\\#00ff001 Account per IP";
   	promptText << endl;
  	promptText << "2 Characters Max per account can be created";
   	promptText << endl;
   	promptText << "1 Character Max can be logged in at any time";
   	promptText << endl;
   	promptText << endl;
   	promptText << endl;
   	promptText << "\\#ffffffServer Rates";
   	promptText << endl;
   	promptText << "\\#00ff001x XP Solo";
   	promptText << endl;
   	promptText << "1.2x XP Grouped";
   	promptText << endl;
   	promptText << "3x XP Bonus when fighting withing 100 meeters of your group";
   	promptText << endl;
   	promptText << endl;
   	promptText << endl;
