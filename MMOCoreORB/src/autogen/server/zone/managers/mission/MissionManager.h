/*
 *	autogen/server/zone/managers/mission/MissionManager.h generated by engine3 IDL compiler 0.60
 */
...
public:
	...
	void randomizeGenericBountyMission(CreatureObject* player, MissionObject* mission, unsigned const int faction);
