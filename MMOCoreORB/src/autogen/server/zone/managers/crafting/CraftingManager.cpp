/*
 *	autogen/server/zone/managers/crafting/CraftingManager.cpp generated by engine3 IDL compiler 0.60
 */
	...
	case RPC_CHECKBIOSKILLMODS__STRING_:
		{
			...
			String _m_res = checkBioSkillMods(property);
			resp->insertAscii(_m_res);
		}
		break;
	...
	case RPC_ALLOWMANUFACTURESCHEMATIC__MANUFACTURESCHEMATIC_:
		{
			...
			bool _m_res = allowManufactureSchematic(manufactureSchematic);
