/*
 *	autogen/server/zone/managers/planet/PlanetManager.h generated by engine3 IDL compiler 0.60
 */
...
public:
	...
	bool isBuildingPermittedAt(float x, float y, SceneObject* objectTryingToBuild = NULL, float margin = 0);
...
protected:
	...
	VectorMap<String, ManagedReference<NavMeshRegion* > > pendingNavMeshes;
...
public:
	...
	bool isBuildingPermittedAt(float x, float y, SceneObject* objectTryingToBuild, float margin);
