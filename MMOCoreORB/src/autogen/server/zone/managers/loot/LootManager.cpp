/*
 *	autogen/server/zone/managers/loot/LootManager.cpp generated by engine3 IDL compiler 0.60
 */
...
unsigned int LootManager::getYellowLooted() {
	LootManagerImplementation* _implementation = static_cast<LootManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
unsigned int LootManager::getExceptionalLooted() {
	LootManagerImplementation* _implementation = static_cast<LootManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
unsigned int LootManager::getLegendaryLooted() {
	LootManagerImplementation* _implementation = static_cast<LootManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
LootGroupMap* LootManager::getLootMap() {
	LootManagerImplementation* _implementation = static_cast<LootManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		throw ObjectNotLocalException(this);
...
unsigned int LootManagerAdapter::getYellowLooted() {
	return (static_cast<LootManager*>(stub))->getYellowLooted();
}

unsigned int LootManagerAdapter::getExceptionalLooted() {
	return (static_cast<LootManager*>(stub))->getExceptionalLooted();
}

unsigned int LootManagerAdapter::getLegendaryLooted() {
