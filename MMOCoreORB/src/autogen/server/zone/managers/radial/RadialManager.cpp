/*
 *	autogen/server/zone/managers/radial/RadialManager.cpp generated by engine3 IDL compiler 0.60
 */
...
enum {RPC_HANDLEOBJECTMENUSELECT__CREATUREOBJECT_BYTE_LONG_ = 618011503,RPC_HANDLEOBJECTMENUREQUEST__CREATUREOBJECT_OBJECTMENURESPONSE_LONG_};
...
void RadialManagerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_HANDLEOBJECTMENUREQUEST__CREATUREOBJECT_OBJECTMENURESPONSE_LONG_:
		{
			CreatureObject* player = static_cast<CreatureObject*>(inv->getObjectParameter());
			ObjectMenuResponse* defaultMenuResponse = static_cast<ObjectMenuResponse*>(inv->getObjectParameter());
			unsigned long long objectID = inv->getUnsignedLongParameter();
			
			handleObjectMenuRequest(player, defaultMenuResponse, objectID);
