/*
 *	autogen/server/zone/Zone.h generated by engine3 IDL compiler 0.60
 */
...
public:
	...
	int getInRangeObjects(float x, float y, float range, InRangeObjectsVector* objects, bool readLockZone);
	...
	int getInRangeNavMeshes(float x, float y, float range, SortedVector<ManagedReference<NavMeshRegion* > >* objects, bool readLockZone);
