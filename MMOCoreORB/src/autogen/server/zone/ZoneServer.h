/*
 *	autogen/server/zone/ZoneServer.h generated by engine3 IDL compiler 0.60
 */
...
public:
	...
	void setShouldDeleteNavRegions(bool b);

	bool shouldDeleteNavRegions();
