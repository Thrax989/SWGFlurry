/*
 *	autogen/server/zone/objects/player/sessions/StructureStatusSession.cpp generated by engine3 IDL compiler 0.60
 */
...
enum {RPC_INITIALIZESESSION__ = 1041474514,RPC_UPDATESTATUS__,RPC_CANCELSESSION__,RPC_CLEARSESSION__};
...
DistributedObjectServant* StructureStatusSession::_getImplementationForRead() const {
	return _impl;
}
