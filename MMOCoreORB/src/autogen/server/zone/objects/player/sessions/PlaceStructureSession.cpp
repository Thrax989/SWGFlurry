/*
 *	autogen/server/zone/objects/player/sessions/PlaceStructureSession.cpp generated by engine3 IDL compiler 0.60
 */
...
int PlaceStructureSessionImplementation::cancelSession() {
	...
	creatureObject.get()->dropActiveSession(SessionFacadeType::PLACESTRUCTURE);
	// server/zone/objects/player/sessions/PlaceStructureSession.idl():  		return 0;
	return 0;
}
