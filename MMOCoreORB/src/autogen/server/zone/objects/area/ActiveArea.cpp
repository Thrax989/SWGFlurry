...
NavMeshRegion* ActiveArea::asNavRegion() {
	ActiveAreaImplementation* _implementation = static_cast<ActiveAreaImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
...
bool ActiveAreaImplementation::isNavRegion() {
	// server/zone/objects/area/ActiveArea.idl():  		return false;
	return false;
}

NavMeshRegion* ActiveAreaImplementation::asNavRegion() {
...
bool ActiveAreaAdapter::isNavRegion() {
	return (static_cast<ActiveArea*>(stub))->isNavRegion();
}
