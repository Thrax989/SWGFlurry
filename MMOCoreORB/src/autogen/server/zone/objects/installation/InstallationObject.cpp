/*
 *	autogen/server/zone/objects/installation/InstallationObject.cpp generated by engine3 IDL compiler 0.60
 */
...
void InstallationObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_BROADCASTMESSAGE__BASEPACKET_BOOL_:
		{
			...
			broadcastMessage(message, sendSelf);
	...
	case RPC_BROADCASTTOOPERATORS__BASEPACKET_:
		{
			BasePacket* packet = static_cast<BasePacket*>(inv->getObjectParameter());
			
			broadcastToOperators(packet);
