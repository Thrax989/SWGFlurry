...
float FsPuzzlePack::getCureSymptomOne() {
	FsPuzzlePackImplementation* _implementation = static_cast<FsPuzzlePackImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
float FsPuzzlePack::getCureSymptomTwo() {
	FsPuzzlePackImplementation* _implementation = static_cast<FsPuzzlePackImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
float FsPuzzlePack::getGiveSymptomOne() {
	FsPuzzlePackImplementation* _implementation = static_cast<FsPuzzlePackImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
	...
	case RPC_GETCURESYMPTOMONE__:
		{
			...
			float _m_res = getCureSymptomOne();
	...
	case RPC_GETCURESYMPTOMTWO__:
		{
			...
			float _m_res = getCureSymptomTwo();
			resp->insertFloat(_m_res);
		}
		break;
	case RPC_GETGIVESYMPTOMONE__:
		{
			...
			float _m_res = getGiveSymptomOne();
			resp->insertFloat(_m_res);
		}
		break;
...
float FsPuzzlePackAdapter::getCureSymptomOne() {
	return (static_cast<FsPuzzlePack*>(stub))->getCureSymptomOne();
}

float FsPuzzlePackAdapter::getCureSymptomTwo() {
	return (static_cast<FsPuzzlePack*>(stub))->getCureSymptomTwo();
}

float FsPuzzlePackAdapter::getGiveSymptomOne() {
...
int LuaFsPuzzlePack::getCureSymptomOne(lua_State *L) {
	...
	if (parameterCount == 0) {
		float result = realObject->getCureSymptomOne();
...
int LuaFsPuzzlePack::getCureSymptomTwo(lua_State *L) {
	...
	if (parameterCount == 0) {
		float result = realObject->getCureSymptomTwo();
...
int LuaFsPuzzlePack::getGiveSymptomOne(lua_State *L) {
	...
	if (parameterCount == 0) {
		float result = realObject->getGiveSymptomOne();
