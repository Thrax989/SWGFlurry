/*
 *	autogen/server/zone/objects/tangible/wearables/WearableObject.cpp generated by engine3 IDL compiler 0.60
 */
...
void WearableObject::applySkillModsTo(CreatureObject* creature) {
	WearableObjectImplementation* _implementation = static_cast<WearableObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void WearableObjectAdapter::applySkillModsTo(CreatureObject* creature) {
