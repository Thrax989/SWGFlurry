/*
 *	autogen/server/zone/objects/tangible/TangibleObject.h generated by engine3 IDL compiler 0.60
 */
...
public:
	 ...
	 * @post { this locked }
	 */
	void setObjectName(StringId& stringID, bool notifyClient);
	...
	bool hasVisibleComponent(int value);
	...
	AutoDeltaSet<int>* getVisibleComponents();
	...
	String getLuaStringData(const String& key);
...
protected:
	...
	TangibleObject* _asTangibleObject();
