/*
 *	autogen/server/zone/objects/tangible/weapon/WeaponObject.cpp generated by engine3 IDL compiler 0.60
 */
...
float WeaponObject::getForceCost() {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
unsigned int WeaponObject::getWeaponBitmask() {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void WeaponObject::applySkillModsTo(CreatureObject* creature) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
float WeaponObjectImplementation::getForceCost() {
...
unsigned int WeaponObjectImplementation::getWeaponBitmask() {
...
float WeaponObjectAdapter::getForceCost() {
...
unsigned int WeaponObjectAdapter::getWeaponBitmask() {
...
void WeaponObjectAdapter::applySkillModsTo(CreatureObject* creature) {
