			...
			if (lua_isnumber(L, -3)) {
				if (lua_isstring(L, -4)) {
					if (parameterCount == 4) {
						...
						throw LuaCallbackException(L, "invalid argument count " + String::valueOf(parameterCount) + " for lua method 'Component:addProperty(string, number, integer, string)'");
					}
				} else {
				...
				if (lua_isnumber(L, -4)) {
					if (lua_isstring(L, -5)) {
						if (parameterCount == 5) {
							...
							throw LuaCallbackException(L, "invalid argument count " + String::valueOf(parameterCount) + " for lua method 'Component:addProperty(string, number, integer, string, boolean)'");
						}
					} else {
