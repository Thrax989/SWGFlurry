/*
 *	autogen/server/zone/objects/building/PoiBuilding.cpp generated by engine3 IDL compiler 0.60
 */
...
void PoiBuildingImplementation::notifyInsert(QuadTreeEntry* entry) {
	...
	if (obj == _this.get())	// server/zone/objects/building/PoiBuilding.idl():  			return;
	return;
