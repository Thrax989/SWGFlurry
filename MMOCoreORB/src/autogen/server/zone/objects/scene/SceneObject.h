/*
 *	autogen/server/zone/objects/scene/SceneObject.h generated by engine3 IDL compiler 0.60
 */
...
public:
	...
	*/
	...
	const Vector<String>* getArrangementDescriptor(int idx);
	...
	bool isFacingObject(SceneObject* obj);
	...
	PlanetMapCategory* getPlanetMapCategory() const;

	PlanetMapCategory* getPlanetMapSubCategory() const;
...
public:
	...
	virtual void setObjectName(StringId& stringID, bool notifyClient);
