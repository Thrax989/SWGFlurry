/*
 *	autogen/server/zone/objects/auction/AuctionItem.cpp generated by engine3 IDL compiler 0.60
 */
...
bool AuctionItem::isOwner(CreatureObject* player) const {
	AuctionItemImplementation* _implementation = static_cast<AuctionItemImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
bool AuctionItemImplementation::isOwner(CreatureObject* player) const{
...
bool AuctionItemAdapter::isOwner(CreatureObject* player) const {
