/*
 *	autogen/server/login/LoginServer.cpp generated by engine3 IDL compiler 0.60
 */
...
enum {RPC_INITIALIZETRANSIENTMEMBERS__ = 2339364972,RPC_INITIALIZE__,RPC_SHUTDOWN__,RPC_STARTMANAGERS__,RPC_STOPMANAGERS__,RPC_START__INT_INT_,RPC_STOP__,RPC_PRINTINFO__,RPC_POPULATEGALAXYLIST__,RPC_GETLOGINENUMCLUSTERMESSAGE__,RPC_GETLOGINCLUSTERSTATUSMESSAGE__};
...
LoginEnumCluster* LoginServerImplementation::getLoginEnumClusterMessage() {
	...
	return dynamic_cast<LoginEnumCluster*>(enumClusterMessage->clone());
}
...
LoginClusterStatus* LoginServerImplementation::getLoginClusterStatusMessage() {
	...
	return dynamic_cast<LoginClusterStatus*>(clusterStatusMessage->clone());
}
	...
	case RPC_GETLOGINENUMCLUSTERMESSAGE__:
		{
			...
			DistributedObject* _m_res = getLoginEnumClusterMessage();
	...
	case RPC_GETLOGINCLUSTERSTATUSMESSAGE__:
		{
			...
			DistributedObject* _m_res = getLoginClusterStatusMessage();
			resp->insertLong(_m_res == NULL ? 0 : _m_res->_getObjectID());
		}
		break;
	default:
