outbreak_undead_deathtrooper_19_m = Creature:new {
	--objectName = "@mob/creature_names:outbreak_undead_deathtrooper_19_m",
...
CreatureTemplates:addCreatureTemplate(outbreak_undead_deathtrooper_19_m, "outbreak_undead_deathtrooper_19_m")
