outbreak_undead_deathtrooper_09_m = Creature:new {
	--objectName = "@mob/creature_names:outbreak_undead_deathtrooper_09_m",
...
CreatureTemplates:addCreatureTemplate(outbreak_undead_deathtrooper_09_m, "outbreak_undead_deathtrooper_09_m")
