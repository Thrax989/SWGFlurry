corrupted_general_hark = Creature:new {
	customName = "Corrupted General Hark",
	socialGroup = "rebel",
	faction = "rebel",
	level = 300,
	chanceHit = 35.5,
	...
	lootGroups = {
		...
		{
			groups = {
				{group = "darkjedifrs", chance = 10000000}
			},
			lootChance = 5000000
		},
		{
...
CreatureTemplates:addCreatureTemplate(corrupted_general_hark, "corrupted_general_hark")
