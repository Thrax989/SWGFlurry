general_luke = Creature:new {
	customName = "General Luke Skywalker",
	socialGroup = "rebel",
	pvpFaction = "rebel",
	faction = "rebel",
	level = 300,
  ...
  specialDamageMult = 7.5,
	...
	attacks = merge(lightsabermaster,forcepowermaster,pikemanmaster,brawlermaster,fencermaster,swordsmanmaster)
}

CreatureTemplates:addCreatureTemplate(general_luke, "general_luke")
