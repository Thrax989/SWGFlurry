event_chubes = Creature:new {
	...
	attacks = merge(commandomaster,marksmanmaster,carbineermaster,bountyhuntermaster)
}

CreatureTemplates:addCreatureTemplate(event_chubes, "event_chubes")
