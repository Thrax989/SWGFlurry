...
--CUSTOM
includeFile("dungeon/ig_88/serverobjects.lua")
includeFile("dungeon/exarkun_temple/serverobjects.lua")
includeFile("dungeon/nightsister_temple/serverobjects.lua")
