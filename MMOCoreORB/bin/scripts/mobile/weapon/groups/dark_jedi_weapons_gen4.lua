dark_jedi_weapons_gen4 = {
	...
	"object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_gen5_exar_kun.iff",
	"object/weapon/melee/sword/crafted_saber/sword_lightsaber_onehanded_gen5_exar_kun.iff"
