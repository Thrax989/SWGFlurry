geonosis_rebel_clone_trooper_none = Lair:new {
	mobiles = {{"rebel_clone_trooper",6}},
	spawnLimit = 15,
...
addLairTemplate("geonosis_rebel_clone_trooper_none", geonosis_rebel_clone_trooper_none)
