...
geonosis_hellfire_droid_neutral = Lair:new {
	mobiles = {{"hellfire_droid",1}},
	bossMobiles = {{"hellfire_droid_boss",1}},
	spawnLimit = 15,
...
addLairTemplate("geonosis_hellfire_droid_neutral", geonosis_hellfire_droid_neutral)
