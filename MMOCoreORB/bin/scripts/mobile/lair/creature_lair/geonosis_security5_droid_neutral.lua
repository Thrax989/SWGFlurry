...
geonosis_security5_droid_neutral = Lair:new {
	mobiles = {{"security5_droid",1}},
	bossMobiles = {{"security5_droid_boss",1}},
	spawnLimit = 15,
...
addLairTemplate("geonosis_security5_droid_neutral", geonosis_security5_droid_neutral)
