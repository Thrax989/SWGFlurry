...
geonosis_security2_droid_neutral = Lair:new {
	mobiles = {{"security2_droid",1}},
	bossMobiles = {{"security2_droid_boss",1}},
	spawnLimit = 15,
...
addLairTemplate("geonosis_security2_droid_neutral", geonosis_security2_droid_neutral)
