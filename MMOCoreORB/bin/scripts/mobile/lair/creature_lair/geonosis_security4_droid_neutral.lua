...
geonosis_security4_droid_neutral = Lair:new {
	mobiles = {{"security4_droid",1}},
	bossMobiles = {{"security4_droid_boss",1}},
	spawnLimit = 15,
...
addLairTemplate("geonosis_security4_droid_neutral", geonosis_security4_droid_neutral)
