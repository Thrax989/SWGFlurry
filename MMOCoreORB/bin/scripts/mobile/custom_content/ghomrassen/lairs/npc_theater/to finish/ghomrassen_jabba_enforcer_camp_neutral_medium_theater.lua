ghomrassen_jabba_enforcer_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"jabba_enforcer",1},{"jabba_thug",1}},
	spawnLimit = 12,
...
addLairTemplate("ghomrassen_jabba_enforcer_camp_neutral_medium_theater", ghomrassen_jabba_enforcer_camp_neutral_medium_theater)
