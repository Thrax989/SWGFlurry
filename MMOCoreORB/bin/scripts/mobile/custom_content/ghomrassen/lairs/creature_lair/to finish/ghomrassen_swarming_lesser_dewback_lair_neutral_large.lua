ghomrassen_swarming_lesser_dewback_lair_neutral_large = Lair:new {
	mobiles = {{"gr_swarming_lesser_dewback",1}},
	spawnLimit = 15,
...
addLairTemplate("ghomrassen_swarming_lesser_dewback_lair_neutral_large", ghomrassen_swarming_lesser_dewback_lair_neutral_large)
