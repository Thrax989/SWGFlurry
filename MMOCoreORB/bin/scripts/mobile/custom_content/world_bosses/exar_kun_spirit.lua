axkva_min = Creature:new {
	objectName = "@mob/creature_names:exar_kun_spirit",
	socialGroup = "exar_kun_guards",
	faction = "",
	level = 302,
	chanceHit = 30,
	damageMin = 1645,
	...
	baseHAMmax = 471000,
	armor = 3,
	resists = {100,135,135,100,100,100,100,100,25},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(exar_kun_spirit, "exar_kun_spirit")
