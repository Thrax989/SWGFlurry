...
RisVendorConvoTemplate = VendorConvoTemplate:new {
	luaClassHandler = "RisVendorConvoHandler"
}

addConversationTemplate("RisVendorConvoTemplate", RisVendorConvoTemplate);
