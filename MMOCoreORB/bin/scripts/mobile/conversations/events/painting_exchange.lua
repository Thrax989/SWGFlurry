...
painting_exchange_five_screen = ConvoScreen:new {
   ...
   options = {
      ...
      {"Master Kenobi Painting", "2"},
      {"Festive Gathering Painting", "3"},
      {"Master Kenobi Painting", "4"},
      {"New Hope Painting", "5"},
...
painting_exchange_seventy_screen = ConvoScreen:new {
   ...
   options = {
      {"SWG 7 Painting", "27"},
      {"Bio Hazard Painting", "28"},
      {"Imperial PVP Painting", "29"},
      {"Rebel PVP Painting", "30"},
      {"NS Painting", "31"},
      {"NS 2 Painting", "32"},
      {"Outcast Painting", "33"},
      {"Dathomir Forrest Painting", "34"},
      {"Dathomir Plains Painting", "35"},
      {"Dathomir Portal Painting", "36"},
      {"Dathomir Mountain Painting", "37"},
      {"SMC 2 Painting", "38"},
