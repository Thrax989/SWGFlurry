...
--hunting mission
includeFile("spawn/hunting_mission/corellia_hunting_missions.lua")
includeFile("spawn/hunting_mission/dantooine_hunting_missions.lua")
includeFile("spawn/hunting_mission/dathomir_hunting_missions.lua")
includeFile("spawn/hunting_mission/endor_hunting_missions.lua")
includeFile("spawn/hunting_mission/lok_hunting_missions.lua")
includeFile("spawn/hunting_mission/naboo_hunting_missions.lua")
includeFile("spawn/hunting_mission/rori_hunting_missions.lua")
includeFile("spawn/hunting_mission/talus_hunting_missions.lua")
includeFile("spawn/hunting_mission/tatooine_hunting_missions.lua")
includeFile("spawn/hunting_mission/yavin4_hunting_missions.lua")
