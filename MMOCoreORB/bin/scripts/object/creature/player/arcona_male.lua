...
object_creature_player_arcona_male = object_creature_player_shared_arcona_male:new {
	...
	defaultLanguage = 1,
	startingItems = { },
	startingSkills = { "species_arcona", "social_language_basic_comprehend", "social_language_basic_speak", "social_language_huttese_comprehend", "social_language_huttese_speak" }
}
