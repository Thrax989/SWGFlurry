...
object_weapon_ranged_rifle_rifle_blaster_ionization_jawa = object_weapon_ranged_rifle_shared_rifle_blaster_ionization_jawa:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_blaster_ionization_jawa, "object/weapon/ranged/rifle/rifle_blaster_ionization_jawa.iff")
