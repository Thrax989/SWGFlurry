...
object_tangible_loot_loot_schematic_jedi_house_loot_schem = object_tangible_loot_loot_schematic_shared_generic_vehicle:new {

	templateType = LOOTSCHEMATIC,
	objectName = "Jedi House Schematic",
	customName = "Jedi House Schematic",
