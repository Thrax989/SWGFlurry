...
object_tangible_loot_loot_schematic_vehicle_house_loot_schem = object_tangible_loot_loot_schematic_shared_generic_vehicle:new {

	templateType = LOOTSCHEMATIC,
	objectName = "Garage Schematic",
	customName = "Garage Schematic",
