...
object_tangible_loot_loot_schematic_relaxation_house_loot_schem = object_tangible_loot_loot_schematic_shared_generic_vehicle:new {

	templateType = LOOTSCHEMATIC,
	objectName = "Relaxation House Schematic",
	customName = "Relaxation House Schematic",
