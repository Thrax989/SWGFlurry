...
object_tangible_loot_loot_schematic_commando_house_loot_schem = object_tangible_loot_loot_schematic_shared_generic_vehicle:new {

	templateType = LOOTSCHEMATIC,
	objectName = "Commando House Schematic",
	customName = "Commando House Schematic",
