object_tangible_terminal_terminal_gcw_publish_gift = object_tangible_terminal_shared_terminal_gcw_publish_gift:new {
	...
	itemList = {
			...
			"dantooine",
		   {
			...
			"Player City - Remnant (5,000 Credits)", "pc_remnant_travel",
		   },
			"dathomir",
		   {
			...
			--[["hoth",
		   {
			"Scavenger Starport (5,000 Credits)", "scavenger_starport_travel",
		   },]]--
		  	"lok",
		   {
			...
			--[["mandalore",
		   {
			"Sundari Starport (5,000 Credits)", "sundari_starport_travel",
			"Keldabe Starport (5,000 Credits)", "keldabe_starport_travel",
			"Bralsin Starport (5,000 Credits)", "bralsin_starport_travel",
			"Norg Bral Starport (5,000 Credits)", "norg_bral_starport_travel",
			"Shuror Starport (5,000 Credits)", "shuror_starport_travel",
			"Enceri Starport (5,000 Credits)", "enceri_starport_travel",
		   },]]--
			"naboo",
		   {
		 ...
		 --[[	"taanab",
		 	...
		 	"yavin4",
		   {
			...
			"Player City - Temple Mount (5,000 Credits)", "pc_temple_mount_travel",
		   },
		 	--[["kaas",
		   {
