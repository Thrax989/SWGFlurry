object_draft_schematic_vehicle_civilian_hoverlift_speeder = object_draft_schematic_vehicle_civilian_shared_hoverlift_speeder:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_hoverlift_speeder, "object/draft_schematic/vehicle/civilian/hoverlift_speeder.iff")
