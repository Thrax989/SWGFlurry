object_draft_schematic_vehicle_civilian_hover_chair = object_draft_schematic_vehicle_civilian_shared_hover_chair:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_hover_chair, "object/draft_schematic/vehicle/civilian/hover_chair.iff")
