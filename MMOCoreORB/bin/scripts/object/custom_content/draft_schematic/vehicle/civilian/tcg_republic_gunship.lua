object_draft_schematic_vehicle_civilian_tcg_republic_gunship = object_draft_schematic_vehicle_civilian_shared_tcg_republic_gunship:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Republic Gunship",
...
--********************************************************************************
	targetTemplate = "object/tangible/deed/vehicle_deed/tcg_republic_gunship_deed.iff",

	additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_tcg_republic_gunship, "object/draft_schematic/vehicle/civilian/tcg_republic_gunship.iff")
