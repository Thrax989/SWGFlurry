...
object_draft_schematic_weapon_pistol_westar_34 = object_draft_schematic_weapon_shared_pistol_westar_34:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "WESTAR 34 Pistol Schematic",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_westar_34, "object/draft_schematic/weapon/pistol_westar_34.iff")
