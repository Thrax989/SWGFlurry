...
object_draft_schematic_weapon_pistol_de_10_generic = object_draft_schematic_weapon_shared_pistol_de_10_generic:new {
   ...
   targetTemplate = "object/weapon/ranged/pistol/pistol_de_10_generic.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_de_10_generic, "object/draft_schematic/weapon/pistol_de_10_generic.iff")
