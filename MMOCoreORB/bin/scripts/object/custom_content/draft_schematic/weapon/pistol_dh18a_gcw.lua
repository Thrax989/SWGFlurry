...
object_draft_schematic_weapon_pistol_dh18a_gcw = object_draft_schematic_weapon_shared_pistol_dh18a_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "DH18A Pistol Schematic",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_dh18a_gcw, "object/draft_schematic/weapon/pistol_dh18a_gcw.iff")
