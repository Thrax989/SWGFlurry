object_draft_schematic_weapon_appearance_weapon_appearance_rifle_legendary_t21 = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_legendary_t21:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Legendary T21 Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_t21_legendary.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_legendary_t21, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_legendary_t21.iff")
