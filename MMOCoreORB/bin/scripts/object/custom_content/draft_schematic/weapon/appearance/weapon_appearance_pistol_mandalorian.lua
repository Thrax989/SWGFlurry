object_draft_schematic_weapon_appearance_weapon_appearance_pistol_mandalorian = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_mandalorian:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Mandalorian",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_mandalorian, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_mandalorian.iff")
