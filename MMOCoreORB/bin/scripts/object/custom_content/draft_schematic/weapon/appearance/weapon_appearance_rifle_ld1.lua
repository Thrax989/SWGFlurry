object_draft_schematic_weapon_appearance_weapon_appearance_rifle_ld1 = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_ld1:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ld1 Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_ld1, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_ld1.iff")
