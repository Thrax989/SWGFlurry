object_draft_schematic_weapon_appearance_weapon_appearance_carbine_alliance_needler = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_alliance_needler:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_alliance_needler, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_alliance_needler.iff")
