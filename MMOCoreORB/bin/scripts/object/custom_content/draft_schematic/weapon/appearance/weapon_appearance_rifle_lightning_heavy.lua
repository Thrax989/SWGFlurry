object_draft_schematic_weapon_appearance_weapon_appearance_rifle_lightning_heavy = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_lightning_heavy:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Lightning Heavy Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_lightning_heavy, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_lightning_heavy.iff")
