object_draft_schematic_weapon_appearance_weapon_appearance_rifle_tangle_gun7 = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_tangle_gun7:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Tangle Gun7 Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_tangle_gun7, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_tangle_gun7.iff")
