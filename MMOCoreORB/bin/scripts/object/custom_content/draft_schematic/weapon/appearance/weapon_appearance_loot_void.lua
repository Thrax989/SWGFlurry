object_draft_schematic_weapon_appearance_weapon_appearance_loot_void = object_draft_schematic_weapon_appearance_shared_weapon_appearance_loot_void:new {
   ...
   targetTemplate = "object/weapon/ranged/heavy/ep3_loot_void.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_loot_void, "object/draft_schematic/weapon/appearance/weapon_appearance_loot_void.iff")
