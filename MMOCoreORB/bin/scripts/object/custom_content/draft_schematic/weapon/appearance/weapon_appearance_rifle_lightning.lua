object_draft_schematic_weapon_appearance_weapon_appearance_rifle_lightning = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_lightning:new {
   ...
   targetTemplate = "object/weapon/ranged/rifle/quest_rifle_lightning.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_lightning, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_lightning.iff")
