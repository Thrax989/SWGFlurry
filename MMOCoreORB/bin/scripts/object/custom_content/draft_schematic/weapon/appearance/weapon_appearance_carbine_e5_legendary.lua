object_draft_schematic_weapon_appearance_weapon_appearance_carbine_e5_legendary = object_draft_schematic_weapon_appearance_shared_weapon_appearance_carbine_e5_legendary:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "E5 Legendary Carbine",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_carbine_e5_legendary, "object/draft_schematic/weapon/appearance/weapon_appearance_carbine_e5_legendary.iff")
