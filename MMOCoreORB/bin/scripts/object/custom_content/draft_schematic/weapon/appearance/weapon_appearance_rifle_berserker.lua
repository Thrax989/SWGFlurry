object_draft_schematic_weapon_appearance_weapon_appearance_rifle_berserker = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_berserker:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Berserker Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_berserker, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_berserker.iff")
