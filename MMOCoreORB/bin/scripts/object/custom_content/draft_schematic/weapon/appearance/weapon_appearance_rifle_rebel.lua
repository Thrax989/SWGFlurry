object_draft_schematic_weapon_appearance_weapon_appearance_rifle_rebel = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_rebel:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_rebel, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_rebel.iff")
