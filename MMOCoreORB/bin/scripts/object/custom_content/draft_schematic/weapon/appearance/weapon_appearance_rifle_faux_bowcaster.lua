object_draft_schematic_weapon_appearance_weapon_appearance_rifle_faux_bowcaster = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_faux_bowcaster:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Faux Bowcaster Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_faux_bowcaster, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_faux_bowcaster.iff")
