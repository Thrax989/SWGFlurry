object_draft_schematic_weapon_appearance_weapon_appearance_rifle_light_blaster_laser_carbine = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_light_blaster_laser_carbine:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Light Blaster Laser Carbine Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_laser_light.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_light_blaster_laser_carbine, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_light_blaster_laser_carbine.iff")
