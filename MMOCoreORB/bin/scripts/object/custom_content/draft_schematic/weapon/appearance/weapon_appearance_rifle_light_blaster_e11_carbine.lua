object_draft_schematic_weapon_appearance_weapon_appearance_rifle_light_blaster_e11_carbine = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_light_blaster_e11_carbine:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Light Blaster E11 Carbine Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_e11_generic.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_light_blaster_e11_carbine, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_light_blaster_e11_carbine.iff")
