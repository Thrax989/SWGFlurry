object_draft_schematic_weapon_appearance_weapon_appearance_rifle_massassi_ink = object_draft_schematic_weapon_appearance_shared_weapon_appearance_rifle_massassi_ink:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_rifle_massassi_ink, "object/draft_schematic/weapon/appearance/weapon_appearance_rifle_massassi_ink.iff")
