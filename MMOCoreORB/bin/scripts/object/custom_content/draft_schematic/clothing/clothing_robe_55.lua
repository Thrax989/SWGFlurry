object_draft_schematic_clothing_clothing_robe_55 = object_draft_schematic_clothing_shared_clothing_robe_55:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 55",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_55, "object/draft_schematic/clothing/clothing_robe_55.iff")
