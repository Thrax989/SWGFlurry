object_draft_schematic_clothing_clothing_robe_14 = object_draft_schematic_clothing_shared_clothing_robe_14:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 14",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark_s04.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_14, "object/draft_schematic/clothing/clothing_robe_14.iff")
