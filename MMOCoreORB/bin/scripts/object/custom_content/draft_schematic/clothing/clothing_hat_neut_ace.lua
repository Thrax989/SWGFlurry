object_draft_schematic_clothing_clothing_hat_neut_ace = object_draft_schematic_clothing_shared_clothing_hat_neut_ace:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Neutral Ace Hat",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_hat_neut_ace, "object/draft_schematic/clothing/clothing_hat_neut_ace.iff")
