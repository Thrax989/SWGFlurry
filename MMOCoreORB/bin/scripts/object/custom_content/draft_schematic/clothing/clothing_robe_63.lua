object_draft_schematic_clothing_clothing_robe_63 = object_draft_schematic_clothing_shared_clothing_robe_63:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 63",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_s33.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_63, "object/draft_schematic/clothing/clothing_robe_63.iff")
