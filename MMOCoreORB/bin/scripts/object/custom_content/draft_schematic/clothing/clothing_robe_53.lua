object_draft_schematic_clothing_clothing_robe_53 = object_draft_schematic_clothing_shared_clothing_robe_53:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 53",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_revan.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_53, "object/draft_schematic/clothing/clothing_robe_53.iff")
