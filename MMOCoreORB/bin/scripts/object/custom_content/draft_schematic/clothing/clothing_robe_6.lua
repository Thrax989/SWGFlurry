object_draft_schematic_clothing_clothing_robe_6 = object_draft_schematic_clothing_shared_clothing_robe_6:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 6",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark2_s01.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_6, "object/draft_schematic/clothing/clothing_robe_6.iff")
