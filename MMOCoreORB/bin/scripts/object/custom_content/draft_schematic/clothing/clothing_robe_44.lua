object_draft_schematic_clothing_clothing_robe_44 = object_draft_schematic_clothing_shared_clothing_robe_44:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 44",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_sith_s01.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_44, "object/draft_schematic/clothing/clothing_robe_44.iff")
