object_draft_schematic_clothing_clothing_robe_48 = object_draft_schematic_clothing_shared_clothing_robe_48:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 48",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_sith_s05.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_48, "object/draft_schematic/clothing/clothing_robe_48.iff")
