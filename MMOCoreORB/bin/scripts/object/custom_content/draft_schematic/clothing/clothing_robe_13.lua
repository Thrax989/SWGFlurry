object_draft_schematic_clothing_clothing_robe_13 = object_draft_schematic_clothing_shared_clothing_robe_13:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 13",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark_s03.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_13, "object/draft_schematic/clothing/clothing_robe_13.iff")
