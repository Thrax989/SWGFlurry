object_draft_schematic_clothing_clothing_robe_27 = object_draft_schematic_clothing_shared_clothing_robe_27:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 27",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_grey_s05.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_27, "object/draft_schematic/clothing/clothing_robe_27.iff")
