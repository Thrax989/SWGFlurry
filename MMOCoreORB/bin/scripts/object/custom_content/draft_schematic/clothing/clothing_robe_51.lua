object_draft_schematic_clothing_clothing_robe_51 = object_draft_schematic_clothing_shared_clothing_robe_51:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 51",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_test.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_51, "object/draft_schematic/clothing/clothing_robe_51.iff")
