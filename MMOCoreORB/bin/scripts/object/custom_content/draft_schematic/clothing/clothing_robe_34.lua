object_draft_schematic_clothing_clothing_robe_34 = object_draft_schematic_clothing_shared_clothing_robe_34:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 34",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_light_s02.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_34, "object/draft_schematic/clothing/clothing_robe_34.iff")
