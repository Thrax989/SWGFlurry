object_draft_schematic_clothing_clothing_robe_62 = object_draft_schematic_clothing_shared_clothing_robe_62:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 62",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_62, "object/draft_schematic/clothing/clothing_robe_62.iff")
