object_draft_schematic_clothing_clothing_robe_8 = object_draft_schematic_clothing_shared_clothing_robe_8:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 8",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark2_s03.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_, "object/draft_schematic/clothing/clothing_robe_.iff")
