object_draft_schematic_clothing_clothing_robe_21 = object_draft_schematic_clothing_shared_clothing_robe_21:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 21",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_21, "object/draft_schematic/clothing/clothing_robe_21.iff")
