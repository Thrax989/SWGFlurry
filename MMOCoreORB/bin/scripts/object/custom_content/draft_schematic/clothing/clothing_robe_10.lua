object_draft_schematic_clothing_clothing_robe_10 = object_draft_schematic_clothing_shared_clothing_robe_10:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 10",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_10, "object/draft_schematic/clothing/clothing_robe_10.iff")
