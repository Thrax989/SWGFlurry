object_draft_schematic_clothing_clothing_robe_16 = object_draft_schematic_clothing_shared_clothing_robe_16:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 16",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_16, "object/draft_schematic/clothing/clothing_robe_16.iff")
