object_draft_schematic_clothing_clothing_robe_26 = object_draft_schematic_clothing_shared_clothing_robe_26:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 26",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_grey_s04.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_26, "object/draft_schematic/clothing/clothing_robe_26.iff")
