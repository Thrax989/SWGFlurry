object_draft_schematic_clothing_clothing_robe_45 = object_draft_schematic_clothing_shared_clothing_robe_45:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 45",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_sith_s02.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_45, "object/draft_schematic/clothing/clothing_robe_45.iff")
