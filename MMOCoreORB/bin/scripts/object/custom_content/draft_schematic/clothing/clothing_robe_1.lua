object_draft_schematic_clothing_clothing_robe_1 = object_draft_schematic_clothing_shared_clothing_robe_1:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 1",
   ...
   targetTemplate = "object/tangible/wearables/robe/aakuan_robe.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_1, "object/draft_schematic/clothing/clothing_robe_1.iff")
