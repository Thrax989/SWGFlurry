object_draft_schematic_clothing_clothing_robe_25 = object_draft_schematic_clothing_shared_clothing_robe_25:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 25",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_grey_s03.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_25, "object/draft_schematic/clothing/clothing_robe_25.iff")
