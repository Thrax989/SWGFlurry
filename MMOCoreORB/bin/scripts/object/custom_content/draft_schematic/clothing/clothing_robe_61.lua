object_draft_schematic_clothing_clothing_robe_61 = object_draft_schematic_clothing_shared_clothing_robe_61:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 61",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_s32.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_61, "object/draft_schematic/clothing/clothing_robe_61.iff")
