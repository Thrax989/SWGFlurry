object_draft_schematic_clothing_clothing_robe_23 = object_draft_schematic_clothing_shared_clothing_robe_23:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 23",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_grey_s01.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_23, "object/draft_schematic/clothing/clothing_robe_23.iff")
