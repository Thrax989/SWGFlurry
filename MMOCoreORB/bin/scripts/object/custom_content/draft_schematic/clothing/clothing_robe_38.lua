object_draft_schematic_clothing_clothing_robe_38 = object_draft_schematic_clothing_shared_clothing_robe_38:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 38",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_38, "object/draft_schematic/clothing/clothing_robe_38.iff")
