object_draft_schematic_clothing_clothing_robe_64 = object_draft_schematic_clothing_shared_clothing_robe_64:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 64",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_64, "object/draft_schematic/clothing/clothing_robe_64.iff")
