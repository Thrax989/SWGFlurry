object_draft_schematic_clothing_clothing_robe_49 = object_draft_schematic_clothing_shared_clothing_robe_49:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 49",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_49, "object/draft_schematic/clothing/clothing_robe_49.iff")
