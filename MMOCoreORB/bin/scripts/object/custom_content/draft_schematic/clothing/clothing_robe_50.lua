object_draft_schematic_clothing_clothing_robe_50 = object_draft_schematic_clothing_shared_clothing_robe_50:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 50",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_50, "object/draft_schematic/clothing/clothing_robe_50.iff")
