object_draft_schematic_clothing_clothing_robe_46 = object_draft_schematic_clothing_shared_clothing_robe_46:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 46",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_sith_s03.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_46, "object/draft_schematic/clothing/clothing_robe_46.iff")
