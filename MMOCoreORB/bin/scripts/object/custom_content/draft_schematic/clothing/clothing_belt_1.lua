object_draft_schematic_clothing_clothing_belt_1 = object_draft_schematic_clothing_shared_clothing_belt_1:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Jedi Belt Pouch",
   ...
   targetTemplate = "object/tangible/wearables/backpack/padawan_pouch.if",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_belt_1, "object/draft_schematic/clothing/clothing_belt_1.iff")
