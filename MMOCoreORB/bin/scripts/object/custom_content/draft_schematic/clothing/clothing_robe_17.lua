object_draft_schematic_clothing_clothing_robe_17 = object_draft_schematic_clothing_shared_clothing_robe_17:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 17",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_17, "object/draft_schematic/clothing/clothing_robe_17.iff")
