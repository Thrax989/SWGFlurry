object_draft_schematic_clothing_clothing_robe_2 = object_draft_schematic_clothing_shared_clothing_robe_2:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 2",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_atris.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_2, "object/draft_schematic/clothing/clothing_robe_2.iff")
