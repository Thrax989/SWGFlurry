object_draft_schematic_clothing_clothing_robe_5 = object_draft_schematic_clothing_shared_clothing_robe_5:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 5",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_5, "object/draft_schematic/clothing/clothing_robe_5.iff")
