object_draft_schematic_clothing_clothing_robe_60 = object_draft_schematic_clothing_shared_clothing_robe_60:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 60",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_60, "object/draft_schematic/clothing/clothing_robe_60.iff")
