object_draft_schematic_clothing_clothing_robe_15 = object_draft_schematic_clothing_shared_clothing_robe_15:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 15",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark_s05.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_15, "object/draft_schematic/clothing/clothing_robe_15.iff")
