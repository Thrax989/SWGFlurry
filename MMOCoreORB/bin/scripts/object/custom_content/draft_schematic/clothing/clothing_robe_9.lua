object_draft_schematic_clothing_clothing_robe_9 = object_draft_schematic_clothing_shared_clothing_robe_9:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 9",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark2_s04.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_9, "object/draft_schematic/clothing/clothing_robe_9.iff")
