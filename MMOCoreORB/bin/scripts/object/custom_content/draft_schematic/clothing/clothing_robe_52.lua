object_draft_schematic_clothing_clothing_robe_52 = object_draft_schematic_clothing_shared_clothing_robe_52:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 52",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_prefect_talmont.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_52, "object/draft_schematic/clothing/clothing_robe_52.iff")
