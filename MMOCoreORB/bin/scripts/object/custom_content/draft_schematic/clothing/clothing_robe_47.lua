object_draft_schematic_clothing_clothing_robe_47 = object_draft_schematic_clothing_shared_clothing_robe_47:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 47",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_sith_s04.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_47, "object/draft_schematic/clothing/clothing_robe_47.iff")
