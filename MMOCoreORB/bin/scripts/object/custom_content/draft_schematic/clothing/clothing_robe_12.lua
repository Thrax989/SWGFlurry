object_draft_schematic_clothing_clothing_robe_12 = object_draft_schematic_clothing_shared_clothing_robe_12:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 12",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark_s02.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_12, "object/draft_schematic/clothing/clothing_robe_12.iff")
