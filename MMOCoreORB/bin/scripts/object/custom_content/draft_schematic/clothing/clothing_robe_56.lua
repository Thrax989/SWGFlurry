object_draft_schematic_clothing_clothing_robe_56 = object_draft_schematic_clothing_shared_clothing_robe_56:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 56",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_56, "object/draft_schematic/clothing/clothing_robe_56.iff")
