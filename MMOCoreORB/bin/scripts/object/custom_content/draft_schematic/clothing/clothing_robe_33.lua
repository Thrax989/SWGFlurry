object_draft_schematic_clothing_clothing_robe_33 = object_draft_schematic_clothing_shared_clothing_robe_33:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 33",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_light_s01.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_33, "object/draft_schematic/clothing/clothing_robe_33.iff")
