object_draft_schematic_clothing_clothing_robe_4 = object_draft_schematic_clothing_shared_clothing_robe_4:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 4",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_4, "object/draft_schematic/clothing/clothing_robe_4.iff")
