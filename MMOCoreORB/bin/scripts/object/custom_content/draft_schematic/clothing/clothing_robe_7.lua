object_draft_schematic_clothing_clothing_robe_7 = object_draft_schematic_clothing_shared_clothing_robe_7:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "New Robe 7",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_jedi_dark2_s02.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_7, "object/draft_schematic/clothing/clothing_robe_7.iff")
