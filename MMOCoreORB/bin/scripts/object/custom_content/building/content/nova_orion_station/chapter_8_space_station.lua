object_building_content_nova_orion_station_chapter_8_space_station = object_building_content_nova_orion_station_shared_chapter_8_space_station:new {
	...
	gameObjectType = 521,
	childObjects = {
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = 90.598, z = 0.8, y = -46.243, ox = 0, oy = -0.45399, oz = 0, ow = 0.891006, cellid = 8, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = 89.1, z = .8, y = -46.8, ox = 0, oy = -0.38268, oz = 0, ow = 0.92388, cellid = 8, containmentType = -1},
