object_building_mustafar_structures_must_new_mining_facility = object_building_mustafar_structures_shared_must_new_mining_facility:new {
	...
	gameObjectType = 521,
	childObjects = {
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -54, z = 31.5, y = -122, ox = 0, oy = 0, oz = 0, ow = 0, cellid = 29, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -50, z = 30.7, y = -140, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
