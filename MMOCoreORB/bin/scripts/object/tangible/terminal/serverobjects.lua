...
includeFile("tangible/terminal/terminal_clone_droid.lua")
includeFile("tangible/terminal/crafting_assembly_terminal.lua")
includeFile("tangible/terminal/terminal_working_droid_factory_exit_door.lua")
includeFile("tangible/terminal/terminal_myyydril_door.lua")
