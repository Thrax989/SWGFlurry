...
ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_tcg_military_transport_deed, "object/tangible/deed/vehicle_deed/tcg_military_transport.iff")
