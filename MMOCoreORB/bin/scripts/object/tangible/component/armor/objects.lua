...
object_tangible_component_armor_shared_riot_shield_pvp = SharedTangibleObjectTemplate:new {
    clientTemplateFileName = "object/tangible/component/armor/shared_riot_shield_pvp.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_component_armor_shared_riot_shield_pvp, "object/tangible/component/armor/shared_riot_shield_pvp.iff")
