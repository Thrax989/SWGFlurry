...
object_tangible_component_bio_bio_component_clothing_field_defense_2 = object_tangible_component_bio_shared_bio_component_clothing_field_defense_2:new {
	...
	experimentalSubGroupTitles = {"null", "null", "decayrate", "hitpoints", "@obj_attr_n:bio_comp_ranged_defense", "cat_skill_mod_bonus.@stat_n:ranged_defense", "@obj_attr_n:bio_comp_melee_defense", "cat_skill_mod_bonus.@stat_n:melee_defense"},
	experimentalMin = {0, 0, 30, 1000, 115, 23, 116, 23},
	experimentalMax = {0, 0, 50, 1000, 115, 26, 116, 26},
