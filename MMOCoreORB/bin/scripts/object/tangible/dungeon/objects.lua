...
object_tangible_dungeon_shared_cloud_city_key = SharedTangibleObjectTemplate:new {
    clientTemplateFileName = "object/tangible/dungeon/shared_cloud_city_key.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_dungeon_shared_cloud_city_key, "object/tangible/dungeon/shared_cloud_city_key.iff")
