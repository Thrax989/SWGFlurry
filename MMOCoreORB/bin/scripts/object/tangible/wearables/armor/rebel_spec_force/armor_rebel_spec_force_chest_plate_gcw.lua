...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_spec_force_armor_rebel_spec_force_chest_plate_gcw, "object/tangible/wearables/armor/rebel/spec/force/armor_rebel_spec_force_chest_plate_gcw.iff")
