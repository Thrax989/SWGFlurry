...
includeFile("tangible/wearables/armor/armor_imperial_guard_saber/serverobjects.lua")
includeFile("tangible/wearables/armor/armor_imperial_guard_shadow/serverobjects.lua")
