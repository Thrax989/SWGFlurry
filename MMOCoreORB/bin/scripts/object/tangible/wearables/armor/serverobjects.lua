...
includeFile("tangible/wearables/armor/imperial_guard_saber/serverobjects.lua")
includeFile("tangible/wearables/armor/imperial_guard_shadow/serverobjects.lua")
