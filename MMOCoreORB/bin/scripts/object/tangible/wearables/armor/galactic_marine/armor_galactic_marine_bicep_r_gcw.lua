...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_bicep_r_gcw, "object/tangible/wearables/armor/galactic/marine/armor_galactic_marine_bicep_r_gcw.iff")
