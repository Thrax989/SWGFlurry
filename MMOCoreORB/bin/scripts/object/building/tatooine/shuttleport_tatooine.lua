...
object_building_tatooine_shuttleport_tatooine = object_building_tatooine_shared_shuttleport_tatooine:new {
	...
	childObjects = {
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -13, z = 0.6, y = -9, ox = 0, oy = -0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -13, z = 0.6, y = 10, ox = 0, oy = -0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
