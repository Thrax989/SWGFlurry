...
object_building_player_city_shuttleport_corellia = object_building_player_city_shared_shuttleport_corellia:new {
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -7, z = 0.9, y = 13.5, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = 6, z = 0.9, y = 13.5, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
		...
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = 8.75, z = 0.9, y = 14.5, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
	}
