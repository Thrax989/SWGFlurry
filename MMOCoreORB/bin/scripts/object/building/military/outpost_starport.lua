...
object_building_military_outpost_starport = object_building_military_shared_outpost_starport:new {
	...
	childObjects = {
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = -3.12, z = 0.14659503, y = -17.57, ox = 0, oy = 0.707107, oz = 0, ow = -0.707107, cellid = 1, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_gcw_publish_gift.iff", x = 1, z = 0, y = -10, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
