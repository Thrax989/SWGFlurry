object_draft_schematic_armor_armor_rebel_spec_force_bracer_l_gcw = object_draft_schematic_armor_shared_armor_rebel_spec_force_bracer_l_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Rebel Spec Force Armor Left Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_spec_force_bracer_l_gcw, "object/draft_schematic/armor/armor_rebel_spec_force_bracer_l_gcw.iff")
