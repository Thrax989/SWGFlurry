object_draft_schematic_armor_armor_galactic_marine_bracer_r_gcw = object_draft_schematic_armor_shared_armor_galactic_marine_bracer_r_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Galactic Marine Armor Right Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_galactic_marine_bracer_r_gcw, "object/draft_schematic/armor/armor_galactic_marine_bracer_r_gcw.iff")
