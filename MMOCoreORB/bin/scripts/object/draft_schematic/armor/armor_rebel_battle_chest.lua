object_draft_schematic_armor_armor_rebel_battle_chest = object_draft_schematic_armor_shared_armor_rebel_battle_chest:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_battle_chest, "object/draft_schematic/armor/armor_rebel_battle_chest.iff")
