object_draft_schematic_armor_armor_rebel_battle_gloves = object_draft_schematic_armor_shared_armor_rebel_battle_gloves:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_battle_gloves, "object/draft_schematic/armor/armor_rebel_battle_gloves.iff")
