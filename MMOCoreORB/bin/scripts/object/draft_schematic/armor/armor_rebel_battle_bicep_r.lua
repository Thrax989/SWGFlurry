object_draft_schematic_armor_armor_rebel_battle_bicep_r = object_draft_schematic_armor_shared_armor_rebel_battle_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Right Bicep",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_battle_bicep_r, "object/draft_schematic/armor/armor_rebel_battle_bicep_r.iff")
