object_draft_schematic_armor_armor_rebel_snow_chest = object_draft_schematic_armor_shared_armor_rebel_snow_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Alliance Cold Weather Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_snow_chest, "object/draft_schematic/armor/armor_rebel_snow_chest.iff")
