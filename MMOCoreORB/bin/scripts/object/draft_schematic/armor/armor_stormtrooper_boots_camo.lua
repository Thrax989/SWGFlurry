object_draft_schematic_armor_armor_stormtrooper_boots_camo = object_draft_schematic_armor_shared_armor_stormtrooper_boots_camo:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_stormtrooper_boots_camo, "object/draft_schematic/armor/armor_stormtrooper_boots_camo.iff")
