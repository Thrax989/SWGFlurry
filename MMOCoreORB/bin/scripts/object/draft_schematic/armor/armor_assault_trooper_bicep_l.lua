object_draft_schematic_armor_armor_assault_trooper_bicep_l = object_draft_schematic_armor_shared_armor_assault_trooper_bicep_l:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_assault_trooper_bicep_l, "object/draft_schematic/armor/armor_assault_trooper_bicep_l.iff")
