object_draft_schematic_armor_armor_snowtrooper_bracer_l = object_draft_schematic_armor_shared_armor_snowtrooper_bracer_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Snowtrooper Armor Left Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_snowtrooper_bracer_l, "object/draft_schematic/armor/armor_snowtrooper_bracer_l.iff")
