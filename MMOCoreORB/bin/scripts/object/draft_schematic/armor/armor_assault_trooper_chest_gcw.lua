object_draft_schematic_armor_armor_assault_trooper_chest_gcw = object_draft_schematic_armor_shared_armor_assault_trooper_chest_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Assault Trooper Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_assault_trooper_chest_gcw, "object/draft_schematic/armor/armor_assault_trooper_chest_gcw.iff")
