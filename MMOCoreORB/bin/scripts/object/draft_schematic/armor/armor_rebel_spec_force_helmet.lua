object_draft_schematic_armor_armor_rebel_spec_force_helmet = object_draft_schematic_armor_shared_armor_rebel_spec_force_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Spec Force Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_spec_force_helmet, "object/draft_schematic/armor/armor_rebel_spec_force_helmet.iff")
