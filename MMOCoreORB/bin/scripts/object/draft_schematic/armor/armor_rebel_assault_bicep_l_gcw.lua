object_draft_schematic_armor_armor_rebel_assault_bicep_l_gcw = object_draft_schematic_armor_shared_armor_rebel_assault_bicep_l_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Rebel Assault Armor Left Bicep",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_assault_bicep_l_gcw, "object/draft_schematic/armor/armor_rebel_assault_bicep_l_gcw.iff")
