object_draft_schematic_armor_armor_rebel_snow_bracer_l = object_draft_schematic_armor_shared_armor_rebel_snow_bracer_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Alliance Cold Weather Armor Left Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_snow_bracer_l, "object/draft_schematic/armor/armor_rebel_snow_bracer_l.iff")
