object_draft_schematic_armor_armor_rebel_spec_force_boots_gcw = object_draft_schematic_armor_shared_armor_rebel_spec_force_boots_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Rebel Spec Force Armor Boots",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_spec_force_boots_gcw, "object/draft_schematic/armor/armor_rebel_spec_force_boots_gcw.iff")
