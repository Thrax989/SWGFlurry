object_draft_schematic_armor_armor_rebel_assault_boots = object_draft_schematic_armor_shared_armor_rebel_assault_boots:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_assault_boots, "object/draft_schematic/armor/armor_rebel_assault_boots.iff")
