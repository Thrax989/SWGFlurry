object_draft_schematic_armor_armor_assault_trooper_chest = object_draft_schematic_armor_shared_armor_assault_trooper_chest:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_assault_trooper_chest, "object/draft_schematic/armor/armor_assault_trooper_chest.iff")
