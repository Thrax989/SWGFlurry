object_draft_schematic_armor_armor_scout_trooper_bicep_l_gcw = object_draft_schematic_armor_shared_armor_scout_trooper_bicep_l_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Scout Trooper Armor Left Bicep",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_scout_trooper_bicep_l_gcw, "object/draft_schematic/armor/armor_scout_trooper_bicep_l_gcw.iff")
