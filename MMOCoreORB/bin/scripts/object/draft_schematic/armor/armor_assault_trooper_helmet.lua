object_draft_schematic_armor_armor_assault_trooper_helmet = object_draft_schematic_armor_shared_armor_assault_trooper_helmet:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_assault_trooper_helmet, "object/draft_schematic/armor/armor_assault_trooper_helmet.iff")
