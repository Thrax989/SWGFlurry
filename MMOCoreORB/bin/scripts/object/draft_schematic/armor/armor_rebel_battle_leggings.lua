object_draft_schematic_armor_armor_rebel_battle_leggings = object_draft_schematic_armor_shared_armor_rebel_battle_leggings:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_battle_leggings, "object/draft_schematic/armor/armor_rebel_battle_leggings.iff")
