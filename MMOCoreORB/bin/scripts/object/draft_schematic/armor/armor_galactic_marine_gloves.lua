object_draft_schematic_armor_armor_galactic_marine_gloves = object_draft_schematic_armor_shared_armor_galactic_marine_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Galactic Marine Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_galactic_marine_gloves, "object/draft_schematic/armor/armor_galactic_marine_gloves.iff")
