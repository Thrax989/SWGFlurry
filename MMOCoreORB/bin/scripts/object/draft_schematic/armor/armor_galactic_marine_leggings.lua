object_draft_schematic_armor_armor_galactic_marine_leggings = object_draft_schematic_armor_shared_armor_galactic_marine_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Galactic Marine Armor Leggings",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_galactic_marine_leggings, "object/draft_schematic/armor/armor_galactic_marine_leggings.iff")
