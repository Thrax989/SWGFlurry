object_draft_schematic_armor_armor_rebel_snow_gloves = object_draft_schematic_armor_shared_armor_rebel_snow_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Alliance Cold Weather Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_snow_gloves, "object/draft_schematic/armor/armor_rebel_snow_gloves.iff")
