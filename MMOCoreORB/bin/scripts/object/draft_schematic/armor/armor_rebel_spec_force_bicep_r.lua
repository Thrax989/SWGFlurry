object_draft_schematic_armor_armor_rebel_spec_force_bicep_r = object_draft_schematic_armor_shared_armor_rebel_spec_force_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Spec Force Armor Right Bicep",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_spec_force_bicep_r, "object/draft_schematic/armor/armor_rebel_spec_force_bicep_r.iff")
