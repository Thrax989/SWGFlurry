object_draft_schematic_armor_armor_rebel_battle_helmet = object_draft_schematic_armor_shared_armor_rebel_battle_helmet:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_rebel_battle_helmet, "object/draft_schematic/armor/armor_rebel_battle_helmet.iff")
