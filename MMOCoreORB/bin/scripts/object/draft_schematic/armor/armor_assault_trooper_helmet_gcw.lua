object_draft_schematic_armor_armor_assault_trooper_helmet_gcw = object_draft_schematic_armor_shared_armor_assault_trooper_helmet_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Battle Worn Assault Trooper Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_assault_trooper_helmet_gcw, "object/draft_schematic/armor/armor_assault_trooper_helmet_gcw.iff")
