object_draft_schematic_clothing_clothing_padawan_pouch = object_draft_schematic_clothing_shared_clothing_padawan_pouch:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Jedi Padawan Belt Pouch",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_padawan_pouch, "object/draft_schematic/clothing/clothing_padawan_pouch.iff")