...
object_draft_schematic_clothing_clothing_armor_marauder_chest = object_draft_schematic_clothing_shared_clothing_armor_marauder_chest:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_chest_plate.iff",

   additionalTemplates = {
              }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_chest, "object/draft_schematic/clothing/clothing_armor_marauder_chest.iff")
