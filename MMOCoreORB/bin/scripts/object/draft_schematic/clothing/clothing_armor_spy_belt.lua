...
object_draft_schematic_clothing_clothing_armor_spy_belt = object_draft_schematic_clothing_shared_clothing_armor_spy_belt:new {
templateType = DRAFTSCHEMATIC,

   customObjectName = "Spy Armor Belt",
   ...
   targetTemplate = "object/tangible/wearables/armor/spy/armor_spy_belt.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_spy_belt, "object/draft_schematic/clothing/clothing_armor_spy_belt.iff")
