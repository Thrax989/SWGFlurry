...
object_draft_schematic_clothing_clothing_armor_1composite_boots = object_draft_schematic_clothing_shared_clothing_armor_1composite_boots:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/composite/armor_stormtrooper_boots.iff",

   additionalTemplates = {
              }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_1composite_boots, "object/draft_schematic/clothing/clothing_armor_1composite_boots.iff")
