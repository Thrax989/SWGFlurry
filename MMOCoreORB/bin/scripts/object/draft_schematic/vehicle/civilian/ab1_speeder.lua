...
object_draft_schematic_vehicle_civilian_ab_1_speeder = object_draft_schematic_vehicle_civilian_shared_ab_1_speeder:new {
	...
	ingredientTitleNames = {"vehicle_body", "structural_frame", "custom_turbine"},
	ingredientSlotType = {0, 0, 1},
	resourceTypes = {"metal_nonferrous", "metal_ferrous", "object/tangible/component/vehicle/shared_custom_veh_turbine.iff"},
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_ab_1_speeder, "object/draft_schematic/vehicle/civilian/ab_1_speeder.iff")
