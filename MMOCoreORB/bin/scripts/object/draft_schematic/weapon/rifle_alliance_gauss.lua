object_draft_schematic_weapon_rifle_alliance_gauss = object_draft_schematic_weapon_shared_rifle_alliance_gauss:new {
   ...
   resourceTypes = {"steel_duralloy", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/weapon/shared_scope_weapon.iff",
