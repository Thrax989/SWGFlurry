object_draft_schematic_weapon_2h_sword_vibrosword = object_draft_schematic_weapon_shared_2h_sword_vibrosword:new {
   ...
   ingredientTitleNames = {"sword_core_jacket", "cutting_edge", "grip_unit", "reinforcement_core", "reinforcement_core"},
   ingredientSlotType = {0, 0, 0, 1, 1},
   resourceTypes = {"iron_kammris", "aluminum_phrik", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_reinforcement_core.iff",  "object/tangible/component/weapon/shared_reinforcement_core.iff"},
