object_draft_schematic_weapon_1h_sword_crusader = object_draft_schematic_weapon_shared_1h_sword_crusader:new {
   ...
   ingredientTitleNames = {"sword_core_jacket", "cutting_edge", "grip", "knife_shaft", "vibration_generator", "vibration_generator"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1},
   resourceTypes = {"steel", "iron", "metal", "aluminum", "object/tangible/component/weapon/shared_vibro_unit.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
