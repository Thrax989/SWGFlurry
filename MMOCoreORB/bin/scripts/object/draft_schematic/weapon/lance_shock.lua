object_draft_schematic_weapon_lance_shock = object_draft_schematic_weapon_shared_lance_shock:new {
   ...
   resourceTypes = {"aluminum_phrik", "iron", "metal", "aluminum", "object/tangible/component/weapon/shared_vibro_unit.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
