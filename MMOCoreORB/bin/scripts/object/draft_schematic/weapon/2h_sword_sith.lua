object_draft_schematic_weapon_2h_sword_sith = object_draft_schematic_weapon_shared_2h_sword_sith:new {
   ...
   ingredientTitleNames = {"sword_core_jacket", "grip", "cutting_edge", "jacketed_sword_core", "jacketed_sword_core"},
   ingredientSlotType = {0, 0, 0, 1, 1},
   resourceTypes = {"steel_ditanium", "aluminum_perovskitic", "petrochem_inert_polymer","object/tangible/component/weapon/shared_sword_core.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
