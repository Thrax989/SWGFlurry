object_draft_schematic_weapon_lance_trando = object_draft_schematic_weapon_shared_lance_trando:new {
   ...
   resourceTypes = {"aluminum_phrik", "steel", "metal","object/tangible/component/weapon/shared_vibro_unit.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
