object_draft_schematic_weapon_lance_electric = object_draft_schematic_weapon_shared_lance_electric:new {
   ...
   resourceTypes = {"steel_duranium", "iron", "metal", "aluminum", "object/tangible/component/weapon/shared_vibro_unit.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
