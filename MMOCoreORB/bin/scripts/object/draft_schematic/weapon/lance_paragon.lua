object_draft_schematic_weapon_lance_paragon = object_draft_schematic_weapon_shared_lance_paragon:new {
   ...
   resourceTypes = {"steel_quadranium", "steel", "metal", "copper", "object/tangible/component/weapon/shared_vibro_unit.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
