object_draft_schematic_weapon_heavy_lava_cannon = object_draft_schematic_weapon_shared_heavy_lava_cannon:new {
   ...
   ingredientTitleNames = {"frame_assembly", "receiver_assembly", "grip_assembly", "powerhandler", "stock", "ignition_pulse_generator", "stock"},
   ingredientSlotType = {0, 0, 0, 1, 1, 0, 3},
   resourceTypes = {"steel_quadranium", "copper_platinite", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/weapon/shared_stock.iff", "steel", "object/tangible/component/weapon/shared_stock.iff"},
