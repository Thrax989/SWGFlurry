object_draft_schematic_weapon_unarmed_witch_fan = object_draft_schematic_weapon_shared_unarmed_witch_fan:new {
   ...
   ingredientTitleNames = {"grip_unit", "strike_face", "vibro_unit_and_power_cell_brackets", "power_cell_socket", "vibration_generator", "vibration_generator"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1},
   resourceTypes = {"steel_quadranium", "steel", "metal", "aluminum_linksteel", "object/tangible/component/weapon/shared_vibro_unit.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
