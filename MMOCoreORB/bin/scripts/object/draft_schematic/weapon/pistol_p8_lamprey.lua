object_draft_schematic_weapon_pistol_p8_lamprey = object_draft_schematic_weapon_shared_pistol_p8_lamprey:new {
   ...
   resourceTypes = {"steel_ditanium", "copper_platinite", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/weapon/shared_scope_weapon.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
