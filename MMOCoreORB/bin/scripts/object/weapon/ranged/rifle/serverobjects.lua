...
--Commando Weapons
includeFile("weapon/ranged/rifle/rifle_carbonite_cold_rifle.lua")
includeFile("weapon/ranged/rifle/rifle_som_lava_cannon.lua")
includeFile("weapon/ranged/rifle/rifle_ep3_loot_corellian.lua")
includeFile("weapon/ranged/rifle/rifle_ep3_loot_void.lua")
includeFile("weapon/ranged/rifle/rifle_cr1_blast_cannon.lua")
includeFile("weapon/ranged/rifle/rifle_mandalorian.lua")
includeFile("weapon/ranged/rifle/rifle_particle_beam.lua")
includeFile("weapon/ranged/rifle/rifle_pulse_cannon.lua")
includeFile("weapon/ranged/rifle/rifle_pvp_imperial.lua")
includeFile("weapon/ranged/rifle/rifle_pvp_rebel.lua")
