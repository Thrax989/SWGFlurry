...
randomDotStrength = {0, 0} -- Set for disease. Fire will be x1.5, poison x2.
randomDotDuration = {0, 0} -- Set for poison. Fire will be x1.5, disease x5.
randomDotPotency = {0, 0}
randomDotUses = {0, 0}
