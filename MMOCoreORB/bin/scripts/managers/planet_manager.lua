...
dungeon2 = {
	...
	planetTravelPoints = {
		{name = "Nova Orion Station", x = 4000, z = 0, y = 2000, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	},
...
coruscant = {
	...
	planetTravelPoints = {
		...
		{name = "Starport District", x = -31, z = 40, y = 3203, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
		{name = "Entertainment District", x = 2250, z = 0, y = -4547, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
		{name = "Commercial District", x = -1847, z = 40, y = -175, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
		{name = "Monument Square", x = 1538, z = 40, y = 775, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
