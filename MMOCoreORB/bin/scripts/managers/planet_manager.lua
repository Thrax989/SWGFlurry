...
Insights
Settings
SWGFlurry/MMOCoreORB/bin/scripts/managers/planet_manager.lua
@Thrax989
Thrax989 [Added] Weather Systems For Concorida / ConcordDawn
Latest commit ad06080 on Oct 22, 2020
 History
 4 contributors
@Thrax989@SlayerSG@kissofdarknes@Voxxy-Flurry
1013 lines (842 sloc)  40.7 KB
...
corellia = {
	...
	planetObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = -0.666281, oz = 0, ow = 0.745701, x = -3128, z = 31, y = 2809, parentid = 0}
	}
}
...
coruscant = {
  ...
  planetTravelPoints = {
	...
	planetObjects = {
		{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0, oz = 0, ow = 0, x = 0, z = 0, y = 0, parentid = 0}
	}
}
...
dantooine = {
	...
	planetObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.692641, oz = 0, ow = 0.721282, x = -4223, z = 3, y = -2357, parentid = 0}
	}
}
...
dungeon2 = {
	...
	planetTravelPoints = {
		{name = "Flurry Space Station", x = 6000, z = 0, y = 0, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}
	},
...
mandalore = {
	...
	planetObjects = {
		{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0, oz = 0, ow = 0, x = 1582, z = 4, y = -6410, parentid = 0}
	}
}
