...
veteranRewards = {
		...
		{templateFile = "object/tangible/tcg/series7/garage_display_vehicles/landspeeder_organa.iff", milestone=365, oneTime=false, description="Organa House Decoration"},
		...
		{templateFile = "object/tangible/tcg/series7/garage_display_vehicles/landspeeder_usv5_s02.iff", milestone=365, oneTime=false, description="Usv5 s02 House Decoration"},
