...
veteranRewards = {
		...
		{templateFile = "object/tangible/tcg/series1/decorative_statuette_darth_vader.iff", milestone=30, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/decorative_statuette_princess_leia.iff", milestone=30, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/greeter_deed_bomarr_monk.iff", milestone=30, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/greeter_deed_ewok.iff", milestone=30, oneTime=false, description=""},
		...
		-- 35 Day Rewards
		{templateFile = "object/tangible/tcg/series1/greeter_deed_gungan.iff", milestone=35, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/greeter_deed_jawa.iff", milestone=35, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/greeter_deed_meatlump.iff", milestone=35, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/greeter_deed_serving_droid.iff", milestone=35, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/house_capacity_beru_whitesuns_cookbook.iff", milestone=35, oneTime=false, description=""},
		
		-- 40 Day Rewards
		{templateFile = "object/tangible/tcg/series1/house_capacity_housecleaning_kit.iff", milestone=40, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/house_capacity_organizational_datapad.iff", milestone=40, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/reuseable_buff_item_gorax_ear.iff", milestone=40, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/reuseable_buff_item_morgukai_shadow_scroll.iff", milestone=40, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/reuseable_buff_item_sanyassan_skull.iff", milestone=40, oneTime=false, description=""},
		
		-- 45 Day Rewards
		{templateFile = "object/tangible/tcg/series1/reuseable_buff_item_tusken_talisman.iff", milestone=45, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/target_creature_acklay_display.iff", milestone=45, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/target_creature_deed.iff", milestone=45, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/target_dummy_deed.iff", milestone=45, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/vendor_deed_ewok.iff", milestone=45, oneTime=false, description=""},
		
		-- 50 Day Rewards
		{templateFile = "object/tangible/tcg/series1/vendor_deed_gungan.iff", milestone=50, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/vendor_deed_jawa.iff", milestone=50, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/vendor_deed_meatlump.iff", milestone=50, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/video_game_table.iff", milestone=50, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_arc170_flightsuit.iff", milestone=50, oneTime=false, description=""},
		
		-- 55 Day Rewards
		{templateFile = "object/tangible/tcg/series1/wearable_black_corset_dress.iff", milestone=55, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_glowing_blue_eyes.iff", milestone=55, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_glowing_red_eyes.iff", milestone=55, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_imperial_flightsuit.iff", milestone=55, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_naboo_jacket.iff", milestone=55, oneTime=false, description=""},
		
		-- 60 Day Rewards
		{templateFile = "object/tangible/tcg/series1/wearable_orange_flightsuit.iff", milestone=60, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series1/wearable_orange_flightsuit.iff", milestone=60, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/combine_object_boba_fett_statue.iff", milestone=60, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/combine_object_jango_fett_memorial_statue.iff", milestone=60, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/combine_object_mandalorian_skull_banner.iff", milestone=60, oneTime=false, description=""},
		...
		-- 65 Day Rewards
		{templateFile = "object/tangible/tcg/series3/combine_object_merr_sonn_jt12_jetpack_blueprints.iff", milestone=65, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/consumable_general_grievous_gutsack.iff", milestone=65, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/consumable_hh_15_torpedo_warhead.iff", milestone=65, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/consumable_wookiee_ceremonial_pipe.iff", milestone=65, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_boba_fett_statue.iff", milestone=65, oneTime=false, description=""},
		
		-- 70 Day Rewards
		{templateFile = "object/tangible/tcg/series3/decorative_darth_vader_obi_wan_diorama.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_empal_surecon_center_medical_table.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_emperor_palpatine_statuette.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_hoth_travel_advertisement.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_jango_fett_memorial_statue.iff", milestone=75, oneTime=false, description=""},
		
		-- 75 Day Rewards
		{templateFile = "object/tangible/tcg/series3/decorative_mandalorian_skull_banner.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_merr_sonn_jt12_jetpack_blueprints.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_mustafar_travel_advertisement.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_swg_tcg_painting.iff", milestone=75, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/decorative_wompa_skin_rug.iff", milestone=75, oneTime=false, description=""},
		
		-- 80 Day Rewards
		{templateFile = "object/tangible/tcg/series3/reuseable_buff_gargans_hands_of_seduction.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series3/wearable_guise_of_the_master.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/consumable_ball_of_peace.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/consumable_falleens_fist.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/consumable_t16_toy.iff", milestone=85, oneTime=false, description=""},
		
		-- 85 Day Rewards
		{templateFile = "object/tangible/tcg/series4/decorative_chewbacca_statuette.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_child_bed_01.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_droid_oil_bath.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_han_solo_statuette.iff", milestone=85, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_kashyyyk_travel_advertisement.iff", milestone=85, oneTime=false, description=""},
		
		-- 90 Day Rewards
		{templateFile = "object/tangible/tcg/series4/decorative_leia_r2_diorama.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_medical_table_01.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_stuffed_tauntaun.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_stuffed_wampa.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_tatooine_travel_advertisement.iff", milestone=95, oneTime=false, description=""},
		...
		-- 95 Day Rewards
		{templateFile = "object/tangible/tcg/series4/decorative_tauntaun_ride.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/decorative_tcg_rug_01.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/video_game_table.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/wearable_chandrilan_dress.iff", milestone=95, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series4/wearable_guise_of_vapaad.iff", milestone=95, oneTime=false, description=""},
		
		-- 100 Day Rewards
		{templateFile = "object/tangible/tcg/series5/wearable_ceremonial_travel_headdress.iffc", milestone=100, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series5/varactyl_armor_statue.iff", milestone=100, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series5/nightsister_backpack.iff", milestone=100, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series5/in_home_rain_storm.iff", milestone=100, oneTime=false, description=""},
		{templateFile = "object/tangible/tcg/series5/food_station_jabbas_roasting_spit.iff", milestone=100, oneTime=false, description=""},
