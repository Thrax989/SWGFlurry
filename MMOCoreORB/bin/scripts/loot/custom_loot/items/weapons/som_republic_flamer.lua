som_republic_flamer = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Republic flamer",
	directObjectTemplate = "object/weapon/ranged/heavy/som_republic_flamer.iff",
	craftingValues = {
		{"mindamage",240,476,0},
		{"maxdamage",500,826,0},
...
addLootItemTemplate("som_republic_flamer", som_republic_flamer)
