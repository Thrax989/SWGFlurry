bounty_hunter_schematics = {
	...
	lootItems = {
		...
		{itemTemplate = "bounty_hunter_chest_schematic", weight = 800000},
		{itemTemplate = "bounty_hunter_gloves_schematic", weight = 1100000},
		{itemTemplate = "bounty_hunter_leggings_schematic", weight = 1000000},
		{itemTemplate = "bounty_hunter_helmet_schematic", weight = 800000}
	}
}

addLootGroupTemplate("bounty_hunter_schematics", bounty_hunter_schematics)