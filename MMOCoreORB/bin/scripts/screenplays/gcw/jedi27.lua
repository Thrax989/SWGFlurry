...
registerScreenPlay("jedi27", true)
  
function jedi27:start()
    	self:spawnActiveAreas()
end
  
function jedi27:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi27", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi27", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi27:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi27:notifySpawnAreaLeave(pActiveArea, pMovingObject)
