...
rebelRewardData = {
	weaponsArmorList = {
		"armor_marine_backpack", "armor_rebel_assault_bicep_l", "armor_rebel_assault_bicep_r", "armor_rebel_assault_bracer_l", "armor_rebel_assault_bracer_r", "armor_rebel_assault_boots",
		"armor_rebel_assault_chest_plate", "armor_rebel_assault_helmet", "armor_rebel_assault_leggings", "armor_rebel_assault_gloves","carbine_laser", "pistol_scout_blaster", "rocket_launcher", "mine_drx", "mine_xg",
	},
	...
	weaponsArmor = {
		...
		armor_marine_bicep_l = { index=1, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_bicep_l", item="object/tangible/loot/loot_schematic/rebel_assault_bicep_l_schematic.iff",cost=500},
		armor_marine_bicep_r = { index=2, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_bicep_r", item="object/tangible/loot/loot_schematic/rebel_assault_bicep_r_schematic.iff",cost=500},
		armor_marine_bracer_l = { index=3, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_bracer_l", item="object/tangible/loot/loot_schematic/rebel_assault_bracer_l_schematic.iff",cost=500},
		armor_marine_bracer_r = { index=4, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_bracer_r", item="object/tangible/loot/loot_schematic/rebel_assault_bracer_r_schematic.iff",cost=500},		
		armor_marine_boots = { index=5, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_boots", item="object/tangible/loot/loot_schematic/rebel_assault_boots_schematic.iff",cost=500},
		armor_marine_chest_plate = { index=6, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_chest_plate", item="object/loot/loot_schematic/rebel_assault_chest_plate_schematic.iff",cost=1000},
		armor_marine_helmet = { index=7, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_helmet", item="object/loot/loot_schematic/rebel_assault_helmet_schematic.iff",cost=1000},
		armor_marine_leggings = { index=8, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_leggings", item="object/loot/loot_schematic/rebel_assault_leggings_schematic.iff",cost=1000},
		armor_marine_leggings = { index=9, type=factionRewardType.armor, display="@wearables_name:armor_rebel_assault_gloves", item="object/loot/loot_schematic/rebel_assault_gloves_schematic.iff",cost=1000},
...
imperialRewardData = {
	...
	weaponsArmor = {
		...
		armor_stormtrooper_bicep_l = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bicep_l", item="object/tangible/loot/loot_schematic/stormtrooper_bicep_l_schematic.iff",cost=500},
		armor_stormtrooper_bicep_r = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bicep_r", item="object/tangible/loot/loot_schematic/stormtrooper_bicep_r_schematic.iff",cost=500},
		armor_stormtrooper_boots = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_boots", item="object/tangible/loot/loot_schematic/stormtrooper_boots_schematic.iff",cost=500},
		armor_stormtrooper_chest_plate = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_chest_plate", item="object/tangible/loot/loot_schematic/stormtrooper_chest_plate_schematic.iff", cost=1000},
		armor_stormtrooper_helmet = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_helmet", item="object/tangible/loot/loot_schematic/stormtrooper_helmet_schematic.iff", cost=1000},
		armor_stormtrooper_leggings = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_leggings", item="object/tangible/loot/loot_schematic/stormtrooper_leggings_schematic.iff",cost=1000},
		armor_stormtrooper_bracer_l = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_l", item="object/tangible/loot/loot_schematic/stormtrooper_bracer_l_schematic.iff",cost=500},
		armor_stormtrooper_bracer_r = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_r", item="object/tangible/loot/loot_schematic/stormtrooper_bracer_r_schematic.iff",cost=500},
		armor_stormtrooper_gloves = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_gloves", item="object/tangible/loot/loot_schematic/stormtrooper_gloves_schematic.iff",cost=500},
