...
rebelRewardData = {
	...
	hirelingList = {
		...
		"specforce_procurement_specialist", "specforce_technician", "specforce_wilderness_operative", "rebel_specforce_guerrilla", "acklay", "death_watch_black_sun_assassin", "droideka", "death_watch_s_battle_droid", "nightsister_elder", "death_watch_ghost", "atxt", "dark_adept"
	},
	...
	hirelings = {
		...
		acklay = { type=factionRewardType.hireling, display="@mob/creature_names:geonosian_acklay_bunker_boss", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="acklay", cost=500000},
		death_watch_black_sun_assassin = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_blksun_assassin", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_black_sun_assassin", cost=200000},
		droideka = { type=factionRewardType.hireling, display="@mob/creature_names:droideka", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="droideka", cost=75000},
		death_watch_s_battle_droid = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_super_battle_droid", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_s_battle_droid", cost=2000000},
		nightsister_elder = { type=factionRewardType.hireling, display="@mob/creature_names:nightsister_elder", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="nightsister_elder", cost=1200000},
		death_watch_ghost = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_dthwatch_grey", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_ghost", cost=1200000},
		atxt = { type=factionRewardType.hireling, display="@mob/creature_names:at_st", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="atxt", cost=10000},
		dark_adept = { type=factionRewardType.hireling, display="@mob/creature_names:dark_adept", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="dark_adept", cost=20000000},
	}
}
...
imperialRewardData = {
	...
	hirelingList = {
		...
		"storm_commando", "stormtrooper", "stormtrooper_bombardier", "stormtrooper_medic", "stormtrooper_rifleman", "stormtrooper_sniper", "swamp_trooper", "at_st", "acklay", "death_watch_black_sun_assassin", "droideka", "nightsister_elder", "death_watch_s_battle_droid", "death_watch_ghost", "dark_adept"
	},
	...
	hirelings = {
		...
		at_st = { type=factionRewardType.hireling, display="@mob/creature_names:at_st", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="at_st", cost=10000},
		acklay = { type=factionRewardType.hireling, display="@mob/creature_names:geonosian_acklay_bunker_boss", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="acklay", cost=300000},
		death_watch_black_sun_assassin = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_blksun_assassin", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_black_sun_assassin", cost=100000},
		droideka = { type=factionRewardType.hireling, display="@mob/creature_names:droideka", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="droideka", cost=50000},
		nightsister_elder = { type=factionRewardType.hireling, display="@mob/creature_names:nightsister_elder", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="nightsister_elder", cost=500000},
		death_watch_s_battle_droid = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_super_battle_droid", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_s_battle_droid", cost=1000000},
		death_watch_ghost = { type=factionRewardType.hireling, display="@mob/creature_names:mand_bunker_dthwatch_grey", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="death_watch_ghost", cost=500000},
		dark_adept = { type=factionRewardType.hireling, display="@mob/creature_names:dark_adept", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="dark_adept", cost=2000000},
	},
}
