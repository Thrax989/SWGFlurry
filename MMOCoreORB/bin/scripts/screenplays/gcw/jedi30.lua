...
registerScreenPlay("jedi30", true)
  
function jedi30:start()
    	self:spawnActiveAreas()
end
  
function jedi30:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi30", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi30", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi30:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi30:notifySpawnAreaLeave(pActiveArea, pMovingObject)
