...
registerScreenPlay("jedi22", true)
  
function jedi22:start()
    	self:spawnActiveAreas()
end
  
function jedi22:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi22", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi22", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi22:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi22:notifySpawnAreaLeave(pActiveArea, pMovingObject)
