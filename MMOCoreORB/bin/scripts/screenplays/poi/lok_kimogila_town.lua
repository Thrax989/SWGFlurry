...
function LokKimogilaTownScreenPlay:spawnMobiles()
	spawnMobile("lok", "giant_dune_kimogila", 300, -17.6, 11.9, 2725.2, 159, 0)
	spawnMobile("lok", "giant_dune_kimogila", 300, -25.9, 11.98, 2763.52, 20, 0)
	spawnMobile("lok", "enraged_dune_kimogila", 300, -115.8, 11.99, 2772, 45, 0)
	spawnMobile("lok", "enraged_dune_kimogila", 300, -129.2, 12, 2748, 270, 0)
	spawnMobile("lok", "kimogila", 300, -137.4, 11.9, 2656.9, -97, 0)
	spawnMobile("lok", "kimogila", 300, -118.0, 11.9, 2653.5, -116, 0)
