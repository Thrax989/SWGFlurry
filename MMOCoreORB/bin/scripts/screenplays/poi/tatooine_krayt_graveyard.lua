...
function KraytGraveyardScreenPlay:spawnMobiles()
	spawnMobile("tatooine", "canyon_krayt_dragon_elder", 1800, 7227.5, 33.2, 4495.8, -116, 0)
	spawnMobile("tatooine", "juvenile_canyon_krayt_dragon_elder", 1500, 7233.2, 30.1, 4487.1, -116, 0)
	...
	spawnMobile("tatooine", "canyon_krayt_dragon_elder", 1800, 6872.9, 41.7, 4246.9, -99, 0)
	spawnMobile("tatooine", "juvenile_canyon_krayt_dragon_elder", 1500, 6877.9, 45.5, 4237.0, -99, 0)
	...
	spawnMobile("tatooine", "giant_canyon_krayt_dragon_elder", 1800, 7515.6, 8.7, 4556.5, -35, 0)
	spawnMobile("tatooine", "giant_canyon_krayt_dragon", 1800, 7417.3, 7.7, 4597.9, -128, 0)
	spawnMobile("tatooine", "giant_canyon_krayt_dragon_elder", 1800, 7300.1, 23.3, 4461.9, -156,0)
	...
	spawnMobile("tatooine", "krayt_dragon_adolescent_elder", 1800, 6721.48, 22.5375, 4237.32, 259, 0) 
	spawnMobile("tatooine", "krayt_dragon_ancient_elder", 1800, 6941.21, 14.659, 4350.38, 345, 0) 
	spawnMobile("tatooine", "krayt_dragon_grand_elder", 1800, 7025.98, 11.0999, 4394.16, 267, 0) 
	spawnMobile("tatooine", "krayt_dragon_adolescent_elder", 1800, 7264.23, 74.3621, 4303.81, 342, 0) 
	spawnMobile("tatooine", "giant_canyon_krayt_dragon_elder", 1800, 7356.73, 13.9903, 4495.8, 29, 0) 
	spawnMobile("tatooine", "krayt_dragon_ancient_elder", 1800, 7425.98, 6.75522, 4642.4, 341, 0) 
	spawnMobile("tatooine", "krayt_dragon_adolescent_elder", 1800, 7536.8, 25.227, 4401.88, 336, 0) 
	spawnMobile("tatooine", "krayt_dragon_ancient_elder", 1800, 7535.86, 10.1094, 4730.96, 1, 0) 
