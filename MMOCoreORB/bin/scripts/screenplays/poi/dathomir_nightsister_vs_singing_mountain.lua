...
function NightSisterVsSingingMountainClanScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "singing_mountain_clan_councilwoman",1800,-2520.4,130,1598.8,179,0,true)
	...
	spawnMobile("dathomir", "nightsister_elder",1800,-2519.9,130.6,1470,0,0,true)	
