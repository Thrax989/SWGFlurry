...
function DathomirStaticSpawnsSeScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "spiderclan_elder", 900, 7076.7, 568.5, -6433.6, -136, 0,true)
	spawnMobile("dathomir", "rancor_pygmy", 1800, getRandomNumber(5) + 7099.4, 576.2, getRandomNumber(5) + -6449.9, getRandomNumber(360), 0)
	spawnMobile("dathomir", "rancor_pygmy", 1800, getRandomNumber(5) + 7099.4, 576.2, getRandomNumber(5) + -6449.9, getRandomNumber(360), 0)

	--broken ship engine (6885,-4925)
	spawnMobile("dathomir", "mature_reptilian_flier", 1800, 6874.5, 404.3, -4925.9, 113, 0)
	...
	spawnMobile("dathomir", "nightsister_elder", 900, 1085.0, 103.0, -4485.2, -95, 0,true)
	spawnMobile("dathomir", "rancor_pygmy", 1800, 1105.8, 82.1, -4549.8, -42, 0)
