...
function DathomirStaticSpawnsNwScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "singing_mountain_clan_councilwoman", 900, -2657.9, 545.7, 7368.5, 110, 0)
	...
	spawnMobile("dathomir", "nightsister_elder", 900, -7120.29, 460.67, 1179.38, 35, 0,true)
