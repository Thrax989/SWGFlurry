...
function hellucard_screenplay:spawnMobiles()
  ...
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -693, 8, -6734, -1, 0)
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -703, 8, -6734, -10, 0)
  ...
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -724, 7, -6650, -29, 0)
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -726, 7, -6646, 173, 0)
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -743, 8, -6711, 0, 0)
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -743, 8, -6707, -179, 0)

  spawnMobile("tatooine", "fallen_jedi_h01", 3000, 11, 1, -11, 2, 1845358)
  spawnMobile("tatooine", "fallen_jedi_h01", 3000, -10, 1, -12, -1, 1845359)
