...
function halloween_moenia:notify2NabooDead(T2Naboo, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("naboo", "halloween_skeleton_2", 0, 4917.15, 3.97895, -4849.3, 302, 0) print("Phase 2 Started")
        return 0
end
...
function halloween_moenia:notify3NabooDead(T3Naboo, pKiller)
	local player = LuaCreatureObject(pKiller)
        local pBoss = spawnMobile("naboo", "halloween_skeleton_3", 0, 4910.26, 3.8191, -4846.73, 25, 0) print("Phase 2 Started")
        return 0
end
