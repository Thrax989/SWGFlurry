...
registerScreenPlay("jedi24", true)
  
function jedi24:start()
    	self:spawnActiveAreas()
end
  
function jedi24:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi24", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi24", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi24:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi24:notifySpawnAreaLeave(pActiveArea, pMovingObject)
