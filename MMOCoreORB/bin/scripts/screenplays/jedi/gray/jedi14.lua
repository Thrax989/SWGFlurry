...
registerScreenPlay("jedi14", true)
  
function jedi14:start()
    	self:spawnActiveAreas()
end
  
function jedi14:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi14", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi14", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi14:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi14:notifySpawnAreaLeave(pActiveArea, pMovingObject)
