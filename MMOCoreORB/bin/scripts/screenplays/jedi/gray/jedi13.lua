...
registerScreenPlay("jedi13", true)
  
function jedi13:start()
    	self:spawnActiveAreas()
end
  
function jedi13:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi13", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi13", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi13:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi13:notifySpawnAreaLeave(pActiveArea, pMovingObject)
