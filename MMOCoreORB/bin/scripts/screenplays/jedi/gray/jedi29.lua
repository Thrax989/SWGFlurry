...
registerScreenPlay("jedi29", true)
  
function jedi29:start()
    	self:spawnActiveAreas()
end
  
function jedi29:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi29", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi29", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi29:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi29:notifySpawnAreaLeave(pActiveArea, pMovingObject)
