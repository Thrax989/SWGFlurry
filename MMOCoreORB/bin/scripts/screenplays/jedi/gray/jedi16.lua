...
registerScreenPlay("jedi16", true)
  
function jedi16:start()
    	self:spawnActiveAreas()
end
  
function jedi16:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi16", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi16", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi16:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi16:notifySpawnAreaLeave(pActiveArea, pMovingObject)
