...
registerScreenPlay("jedi26", true)
  
function jedi26:start()
    	self:spawnActiveAreas()
end
  
function jedi26:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi26", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi26", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi26:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi26:notifySpawnAreaLeave(pActiveArea, pMovingObject)
