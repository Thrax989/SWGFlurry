...
registerScreenPlay("jedi11", true)
  
function jedi11:start()
    	self:spawnActiveAreas()
end
  
function jedi11:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi11", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi11", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi11:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi11:notifySpawnAreaLeave(pActiveArea, pMovingObject)
