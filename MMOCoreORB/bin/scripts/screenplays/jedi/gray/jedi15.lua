...
registerScreenPlay("jedi15", true)
  
function jedi15:start()
    	self:spawnActiveAreas()
end
  
function jedi15:spawnActiveAreas()
	...
	if (pSpawnArea ~= nil) then
		local activeArea = LuaActiveArea(pSpawnArea)
	        ...
	        createObserver(ENTEREDAREA, "jedi15", "notifySpawnArea", pSpawnArea)
	        createObserver(EXITEDAREA, "jedi15", "notifySpawnAreaLeave", pSpawnArea)
	    end
end
 
function jedi15:notifySpawnArea(pActiveArea, pMovingObject)
...
function jedi15:notifySpawnAreaLeave(pActiveArea, pMovingObject)
