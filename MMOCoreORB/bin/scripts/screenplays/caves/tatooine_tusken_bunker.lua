...
function TuskenBunkerScreenPlay:spawnMobiles()
		spawnMobile("tatooine", "taiken_dark_apprentice",900,-2.8,-20,29,175,4235606)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, 5,-20,29,179,4235606)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, -10,-13,7,91,4235603)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, 4,0,-4,-90,4235599)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, -7,-17,-4,46,4235604)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, 4,-13,-6,-45,4235601)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, -4,-6,0,-1,4235601)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, -0,0,2,0,4235598)
		spawnMobile("tatooine", "taiken_dark_apprentice",900, -1472,41,-193,-104,0)
