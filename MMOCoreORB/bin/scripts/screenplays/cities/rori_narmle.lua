...
function RoriNarmleScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "trainer_combatmedic", 1, -5169, 80, -2329, 83, 4635420)
	...
	spawnMobile("rori", "trainer_droidengineer", 1, -5331, 80, -2249, 0, 4635415)
	...
	spawnMobile("rori", "trainer_medic", 1, -5328, 80, -2251, 165, 4635420)
	...
	spawnMobile("rori", "trainer_tailor", 1, -5325, 80, -2253, 0, 4615383)
	...
	spawnMobile("rori", "trainer_dancer", 0, -5323, 80, -2253, 1, 4635403)
	--spawnMobile("rori", "theater_manager", 0, 21.5522, 2.12797, 63.5137, 0, 4635403)
	spawnMobile("rori", "trainer_musician", 0, -5321, 80, -2256, 180, 4635403)
end
