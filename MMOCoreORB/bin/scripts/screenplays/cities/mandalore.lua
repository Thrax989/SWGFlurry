...
function MandaloreScreenPlay:spawnMobiles()
	...
	spawnMobile("mandalore", "businessman",60,3.5,1.1,-2.2,-40,8565698)
	spawnMobile("mandalore", "businessman",60,-8.1,6.1,3.6,118,8566536)
	spawnMobile("mandalore", "comm_operator",300,38.4,0.1,-8.3,-44,8565741)
	...
	spawnMobile("mandalore", "corsec_agent",300,2.2,-0.4,-4.6,-75,8565874)
	...
	spawnMobile("mandalore", "entertainer",60,7.0,-0.9,11.9,125,8565743)
	...
	spawnMobile("mandalore", "medic",60,0.9,0.2,-6.4,-45,8565897)
	...
	spawnMobile("mandalore", "r2",60,5.3,1.7,-12.9,-49,8565887)
	...
	spawnMobile("mandalore", "mythosaur",300,1818.4,2.0,-1166.6,-80,0)
	spawnMobile("mandalore", "mythosaur",300,1825.7,15.1,-1083.1,-152,0)
	spawnMobile("mandalore", "mythosaur",300,1741.9,3.0,-1136.6,173,0)
	spawnMobile("mandalore", "mythosaur",300,1731.5,2.5,-1241.6,61,0)
	spawnMobile("mandalore", "mythosaur",300,1781.7,8.6,-1256.5,-12,0)
	...
	spawnMobile("mandalore", "dexton_clan_hunter",120,20.6,-0.9,19.3,-146,85664130)
