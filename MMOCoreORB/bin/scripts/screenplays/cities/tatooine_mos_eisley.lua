...
function TatooineMosEisleyScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "trainer_weaponsmith", 1, 3469.88, 5, -4851.18, 165, 0)
	spawnMobile("tatooine", "trainer_unarmed", 1, 3466.03, 5, -4851.65, 153, 0)
	spawnMobile("tatooine", "trainer_tailor", 1, 3465.17, 5, -4851.75, 151, 0)
	spawnMobile("tatooine", "trainer_squadleader", 1, 3464.41, 5, -4852.12, 87, 0)
	spawnMobile("tatooine", "trainer_spy", 1, 3464.44, 5, -4852.88, 70, 0)
	spawnMobile("tatooine", "trainer_smuggler", 1, 3464.62, 5, -4853.5, 73, 0)
	spawnMobile("tatooine", "trainer_shipwright", 1, 3464.63, 5, -4854.23, 71, 0)
	spawnMobile("tatooine", "trainer_scout", 1, 3464.78, 5, -4855.02, 68, 0)
	spawnMobile("tatooine", "trainer_rifleman", 1, 3464.89, 5, -4855.72, 65, 0)
	spawnMobile("tatooine", "trainer_ranger", 1, 3465.1, 5, -4856.63, 51, 0)
	spawnMobile("tatooine", "trainer_polearm", 1, 3465.15, 5, -4857.59, 55, 0)
	spawnMobile("tatooine", "trainer_pistol", 1, 3465.4, 5, -4858.4, 52, 0)
	spawnMobile("tatooine", "trainer_musician", 1, 3465.13, 5, -4859.5, 108, 0)
	spawnMobile("tatooine", "trainer_merchant", 1, 3464.39, 5, -4860.19, 113, 0)
	spawnMobile("tatooine", "trainer_medic", 1, 3463.41, 5, -4861.55, 123, 0)
	spawnMobile("tatooine", "trainer_marksman", 1, 3463, 5, -4861.92, 118, 0)
	spawnMobile("tatooine", "trainer_imagedesigner", 1, 3462.57, 5, -4862.47, 116, 0)
	spawnMobile("tatooine", "trainer_entertainer", 1, 3462.21, 5, -4863.05, 125, 0)
	spawnMobile("tatooine", "trainer_droidengineer", 1, 3461.71, 5, -4863.55, 115, 0)
	spawnMobile("tatooine", "trainer_doctor", 1, 3461.29, 5, -4864.18, 114, 0)
	spawnMobile("tatooine", "trainer_dancer", 1, 3460.89, 5, -4864.76, 121, 0)
	spawnMobile("tatooine", "trainer_creaturehandler", 1, 3460.46, 5, -4865.26, 115, 0)
	spawnMobile("tatooine", "trainer_commando", 1, 3460.11, 5, -4865.81, 122, 0)
	spawnMobile("tatooine", "trainer_combatmedic", 1, 3459.73, 5, -4866.35, 117, 0)
	spawnMobile("tatooine", "trainer_chef", 1, 3459.32, 5, -4866.91, 116, 0)
	spawnMobile("tatooine", "trainer_carbine", 1, 3458.9, 5, -4867.5, 118, 0)
	spawnMobile("tatooine", "trainer_brawler", 1, 3458.45, 5, -4868, 119, 0)
	spawnMobile("tatooine", "trainer_bountyhunter", 1, 3458.01, 5, -4868.66, 118, 0)
	spawnMobile("tatooine", "trainer_bioengineer", 1, 3457.64, 5, -4869.12, 118, 0)
	spawnMobile("tatooine", "trainer_artisan", 1, 3457.22, 5, -4869.6, 118, 0)
	spawnMobile("tatooine", "trainer_armorsmith", 1, 3456.84, 5, -4870.18, 119, 0)
