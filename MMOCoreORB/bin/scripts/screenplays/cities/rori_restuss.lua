...
function RoriRestussScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "trainer_armorsmith", 0, 5131, 80, 5748, 157, 4635773)
	...
	spawnMobile("rori", "trainer_combatmedic", 0, 5129, 80, 5747, 84, 4635728)
	spawnMobile("rori", "trainer_commando", 0, 5120, 80, 5749, 39, 4635689)
	...
	spawnMobile("rori", "trainer_medic", 0, 5116, 80, 5744, 165, 4635728)
	...
	spawnMobile("rori", "trainer_weaponsmith", 0, 5114, 80, 5742, 0, 4635775)
