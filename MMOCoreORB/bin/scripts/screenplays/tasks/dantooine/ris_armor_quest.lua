...
risArmorQuest = ScreenPlay:new {
		...
		finalRewardSchematics = {
			...
			{ template = "object/draft_schematic/clothing/clothing_armor_mandalorian_boots.iff", displayName = "@wearables_name:armor_mandalorian_shoes" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_bicep_l.iff", displayName = "@wearables_name:armor_bounty_hunter_bicep_l" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_bicep_r.iff", displayName = "@wearables_name:armor_bounty_hunter_bicep_r" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_bracer_l.iff", displayName = "@wearables_name:armor_bounty_hunter_bracer_l" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_bracer_r.iff", displayName = "@wearables_name:armor_bounty_hunter_bracer_r" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_chest_plate.iff", displayName = "@wearables_name:armor_bounty_hunter_chest_plate" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_gloves.iff", displayName = "@wearables_name:armor_bounty_hunter_gloves" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_helmet.iff", displayName = "@wearables_name:armor_bounty_hunter_helmet" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_leggings.iff", displayName = "@wearables_name:armor_bounty_hunter_leggings" },
			{ template = "object/draft_schematic/clothing/clothing_armor_bounty_hunter_boots.iff", displayName = "@wearables_name:armor_bounty_hunter_boots" }
		}
