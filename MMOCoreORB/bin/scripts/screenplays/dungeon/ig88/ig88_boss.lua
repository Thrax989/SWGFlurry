...
if (((bossHealth <= (bossMaxHealth *0.9)) or (bossAction <= (bossMaxAction * 0.9)) or (bossMind <= (bossMaxMind *0.9))) and readData("ig88_boss:spawnState") == 1) then
      ...
      local oAdd = spawnMobile("dungeon2", "droideka", 0, 30.1609, 0.0315462, 41.5876, 216, 14200863)
      spatialChat(oAdd, "target locked")
      local oAdd = spawnMobile("dungeon2", "droideka", 0, 32.5711, 0.0315456, 9.91512, 271, 14200863)
      spatialChat(oAdd, "target locked")
      ...
      local oAddTwo = spawnMobile("dungeon2", "droideka", 0, 25.236, 0.0315455, -16.7366, 295, 14200863)
      spatialChat(oAddTwo, "target locked")
      local oAddTwo = spawnMobile("dungeon2", "droideka", 0, -0.0763456, 0.0315461, 43.036, 181, 14200863)
      spatialChat(oAddTwo, "target locked")
      ...
      local oAddThree = spawnMobile("dungeon2", "droideka", 0, -28.0065, 0.031546, -19.2101, 33, 14200863)
      spatialChat(oAddThree, "target locked")
      local oAddThree = spawnMobile("dungeon2", "droideka", 0, 0.0157171, 0.0315459, -21.8045, 359, 14200863)
      spatialChat(oAddThree, "target locked")
      ...
      local oAddFour = spawnMobile("dungeon2", "droideka", 0, -29.4181, 0.031546, 40.9501, 129, 14200863)
      spatialChat(oAddFour, "target locked")
      local oAddFour = spawnMobile("dungeon2", "droideka", 0, -29.6284, 0.031546, 9.97978, 87, 14200863)
      spatialChat(oAddFour, "target locked")
...
local trapDmg = getRandomNumber(500, 1000)
      ...
      local pAddFive = spawnMobile("dungeon2", "droideka", 0, 30.1609, 0.0315462, 41.5876, 216, 14200863)
      spatialChat(pAddFive, "target locked")
      local pAddFive = spawnMobile("dungeon2", "droideka", 0, 32.5711, 0.0315456, 9.91512, 271, 14200863)
      spatialChat(pAddFive, "target locked")
      ...
      local pAddSix = spawnMobile("dungeon2", "droideka", 0, 25.236, 0.0315455, -16.7366, 295, 14200863)
      spatialChat(pAddSix, "target locked")
      local pAddSix = spawnMobile("dungeon2", "droideka", 0, -0.0763456, 0.0315461, 43.036, 181, 14200863)
      spatialChat(pAddSix, "target locked")
      ...
      local pAddSeven = spawnMobile("dungeon2", "droideka", 0, -28.0065, 0.031546, -19.2101, 33, 14200863)
      spatialChat(pAddSeven, "target locked")
      local pAddSeven = spawnMobile("dungeon2", "droideka", 0, 0.0157171, 0.0315459, -21.8045, 359, 14200863)
      spatialChat(pAddSeven, "target locked")
      ...
      local pAddEight = spawnMobile("dungeon2", "droideka", 0, -29.4181, 0.031546, 40.9501, 129, 14200863)
      spatialChat(pAddEight, "Target Lock")
      local pAddEight = spawnMobile("dungeon2", "droideka", 0, -29.6284, 0.031546, 9.97978, 87, 14200863)
      spatialChat(pAddEight, "Target Lock")
...
if (((bossHealth <= (bossMaxHealth * 0.6)) or (bossAction <= (bossMaxAction * 0.6)) or (bossMind <= (bossMaxMind * 0.6))) and readData("ig88_boss:spawnState") == 4) then
      ...
      local pAddNine = spawnMobile("dungeon2", "droideka", 0, 30.1609, 0.0315462, 41.5876, 216, 14200863)
      spatialChat(pAddNine, "target locked")
      local pAddNine = spawnMobile("dungeon2", "droideka", 0, 32.5711, 0.0315456, 9.91512, 271, 14200863)
      spatialChat(pAddNine, "target locked")
      ...
      local pAddTen = spawnMobile("dungeon2", "droideka", 0, 25.236, 0.0315455, -16.7366, 295, 14200863)
      spatialChat(pAddTen, "target locked")
      local pAddTen = spawnMobile("dungeon2", "droideka", 0, -0.0763456, 0.0315461, 43.036, 181, 14200863)
      spatialChat(pAddTen, "target locked")
      ...
      local pAddEleven = spawnMobile("dungeon2", "droideka", 0, -28.0065, 0.031546, -19.2101, 33, 14200863)
      spatialChat(pAddEleven, "target locked")
      local pAddEleven = spawnMobile("dungeon2", "droideka", 0, 0.0157171, 0.0315459, -21.8045, 359, 14200863)
      spatialChat(pAddEleven, "target locked")
      ...
      local pAddTwelve = spawnMobile("dungeon2", "droideka", 0, -29.4181, 0.031546, 40.9501, 129, 14200863)
      spatialChat(pAddTwelve, "Target Lock")
      local pAddTwelve = spawnMobile("dungeon2", "droideka", 0, -29.6284, 0.031546, 9.97978, 87, 14200863)
      spatialChat(pAddTwelve, "Target Lock")
...
if (((bossHealth <= (bossMaxHealth * 0.5)) or (bossAction <= (bossMaxAction * 0.5)) or (bossMind <= (bossMaxMind * 0.5))) and readData("ig88_boss:spawnState") == 5) then
      ...
      local pAddThirteen = spawnMobile("dungeon2", "droideka", 0, 30.1609, 0.0315462, 41.5876, 216, 14200863)
      spatialChat(pAddThirteen, "target locked")
      local pAddThirteen = spawnMobile("dungeon2", "droideka", 0, 32.5711, 0.0315456, 9.91512, 271, 14200863)
      spatialChat(pAddThirteen, "target locked")
      ...
      local pAddFourteen = spawnMobile("dungeon2", "droideka", 0, 25.236, 0.0315455, -16.7366, 295, 14200863)
      spatialChat(pAddFourteen, "target locked")
      local pAddFourteen = spawnMobile("dungeon2", "droideka", 0, -0.0763456, 0.0315461, 43.036, 181, 14200863)
      spatialChat(pAddFourteen, "target locked")
      ...
      local pAddFifteen = spawnMobile("dungeon2", "droideka", 0, -28.0065, 0.031546, -19.2101, 33, 14200863)
      spatialChat(pAddFifteen, "target locked")
      local pAddFifteen = spawnMobile("dungeon2", "droideka", 0, 0.0157171, 0.0315459, -21.8045, 359, 14200863)
      spatialChat(pAddFifteen, "target locked")
      ...
      local pAddSixteen = spawnMobile("dungeon2", "droideka", 0, -29.4181, 0.031546, 40.9501, 129, 14200863)
      spatialChat(pAddSixteen, "Target Lock")
      local pAddSixteen = spawnMobile("dungeon2", "droideka", 0, -29.6284, 0.031546, 9.97978, 87, 14200863)
      spatialChat(pAddSixteen, "Target Lock")
...
if (((bossHealth <= (bossMaxHealth * 0.4)) or (bossAction <= (bossMaxAction * 0.4)) or (bossMind <= (bossMaxMind * 0.4))) and readData("ig88_boss:spawnState") == 6) then
      ...
      local pAddSeventeen = spawnMobile("dungeon2", "droideka", 0, 30.1609, 0.0315462, 41.5876, 216, 14200863)
      spatialChat(pAddSeventeen, "Target Lock")
      local pAddSeventeen = spawnMobile("dungeon2", "droideka", 0, 32.5711, 0.0315456, 9.91512, 271, 14200863)
      spatialChat(pAddSeventeen, "Target Lock")
      local pAddSeventeen = spawnMobile("dungeon2", "droideka", 0, 25.236, 0.0315455, -16.7366, 295, 14200863)
      spatialChat(pAddSeventeen, "Target Lock")
      local pAddSeventeen = spawnMobile("dungeon2", "droideka", 0, -0.0763456, 0.0315461, 43.036, 181, 14200863)
      spatialChat(pAddSeventeen, "Target Lock")
      ...
      local pAddEighteen = spawnMobile("dungeon2", "droideka", 0, -28.0065, 0.031546, -19.2101, 33, 14200863)
      spatialChat(pAddEighteen, "Target Lock")
      local pAddEighteen = spawnMobile("dungeon2", "droideka", 0, 0.0157171, 0.0315459, -21.8045, 359, 14200863)
      spatialChat(pAddEighteen, "Target Lock")
      local pAddEighteen = spawnMobile("dungeon2", "droideka", 0, -29.4181, 0.031546, 40.9501, 129, 14200863)
      spatialChat(pAddEighteen, "Target Lock")
      local pAddEighteen = spawnMobile("dungeon2", "droideka", 0, -29.6284, 0.031546, 9.97978, 87, 14200863)
      spatialChat(pAddEighteen, "Target Lock")
